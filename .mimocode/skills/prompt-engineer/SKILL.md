...
description: "Use when working with prompt-engineer"
---
...
**Trigger Conditions** â€” ask only if:
...
Step 2 (triggered â€” task type ambiguous):
"To craft the best prompt, I need one quick clarification:
1. What do you want to do with AI â€” build something, learn about it, or use an AI tool for a task?"
```
