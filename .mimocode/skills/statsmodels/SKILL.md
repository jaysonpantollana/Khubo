---
name: statsmodels
description: "Use when working with statsmodels"
---
...
3. **Use appropriate model**: Match model to outcome type (binaryâ†’Logit, countâ†’Poisson)
...
3. **Interpret carefully**: Account for link functions (e.g., exp(Î²) for log link)
...
3. **Wrong model for outcome type**: Binaryâ†’Logit/Probit, Countâ†’Poisson/NB, not OLS
