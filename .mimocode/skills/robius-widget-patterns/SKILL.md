...
description: "Use when working with robius-widget-patterns"
---
...
description: |
  ...
  apply_over, TextOrImage, modal, å¯å¤ç”¨, æ¨¡æ€,
  collapsible, drag drop, reusable widget, widget design,
  pageflip, ç»„ä»¶è®¾è®¡, ç»„ä»¶æ¨¡å¼
risk: unknown
source: community
---
...
| 19-pageflip-optimization | PageFlip åˆ‡æ¢ä¼˜åŒ–ï¼Œå³åˆ»é”€æ¯/ç¼“å­˜æ¨¡å¼ |
