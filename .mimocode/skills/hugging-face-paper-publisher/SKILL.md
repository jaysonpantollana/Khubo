...
description: "Use when working with hugging-face-paper-publisher"
---
...
**Manage in Settings:**
Navigate to your account settings â†’ Papers section to toggle "Show on profile" for each paper.
...
```bash
# Write â†’ Publish â†’ Index â†’ Link
