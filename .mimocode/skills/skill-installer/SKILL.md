...
description: "Use when working with skill-installer"
---
...
â”œâ”€â”€ scripts/
â”‚   â”œâ”€â”€ install_skill.py  <- instalador principal (11 passos) + todos os comandos
â”‚   â”œâ”€â”€ detect_skills.py  <- scanner de skills nao-instaladas
â”‚   â”œâ”€â”€ validate_skill.py <- validacao profunda (10 checks)
â”‚   â”œâ”€â”€ package_skill.py  <- empacotador ZIP + verificador de integridade
â”‚   â””â”€â”€ requirements.txt
â”œâ”€â”€ references/
â”‚   â””â”€â”€ known-locations.md
â””â”€â”€ data/
    â”œâ”€â”€ install_log.json  <- log de operacoes (auto-gerado, com rotacao)
    â”œâ”€â”€ backups/          <- backups antes de sobrescrever
    â””â”€â”€ staging/          <- area temporaria para copias seguras
```
