...
description: "Use when working with azure-mgmt-applicationinsights-dotnet"
---
...
Subscription
â””â”€â”€ ResourceGroup
    â””â”€â”€ ApplicationInsightsComponent          # App Insights resource
        â”œâ”€â”€ ApplicationInsightsComponentApiKey  # API keys for programmatic access
        â”œâ”€â”€ ComponentLinkedStorageAccount      # Linked storage for data export
        â””â”€â”€ (via component ID)
            â”œâ”€â”€ WebTest                        # Availability tests
            â”œâ”€â”€ Workbook                       # Workbooks for analysis
            â”œâ”€â”€ WorkbookTemplate               # Workbook templates
            â””â”€â”€ MyWorkbook                     # Private workbooks
```
...
1. **Use workspace-based** â€” Workspace-based App Insights is the current standard
2. **Link to Log Analytics** â€” Store data in Log Analytics for better querying
3. **Set appropriate retention** â€” Balance cost vs. data availability
4. **Use sampling** â€” Reduce costs for high-volume applications
5. **Store connection string securely** â€” Use Key Vault or managed identity
6. **Enable multiple test locations** â€” For accurate availability monitoring
7. **Use workbooks** â€” For custom dashboards and analysis
8. **Set up alerts** â€” Based on availability tests and metrics
9. **Tag resources** â€” For cost allocation and organization
10. **Use private endpoints** â€” For secure data ingestion
