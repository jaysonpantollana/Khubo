...
description: "Use when working with smart-git-automation"
---
...
- Streamlined workflow: scan â†’ branch â†’ commit â†’ push â†’ PR with fewer prompts
...
- Files in the same module/directory â†’ likely related
- Files that were modified together in recent edits â†’ likely related
- New files that complement each other â†’ likely related

Present grouped changes in a clear format, e.g.:
```
ðŸ“ Group 1: UI Components
  - src/components/Button.tsx (modified)
  - src/components/Button.test.tsx (modified)

ðŸ“ Group 2: API Layer
