---
name: skill-router
description: "Use when working with skill-router"
---
...
relevant skill(s) from the installed library â€” with a clear explanation of
...
### Step 1 â€” Acknowledge and open the interview
...
Example opener:
> "No problem â€” let me ask you a few quick questions so I can point you to
> exactly the right skill."

---

### Step 2 â€” Ask the Funnel Questions (one at a time, in order)

Ask only what you need. If an earlier answer makes a later question
irrelevant, skip it.

**Q1 â€” What is the broad area of the task?**
...
**Q3 â€” What tech stack or domain is involved?** (only ask if relevant)
Examples: React / Next.js, Node.js, Python, AWS, Stripe, AI/LLM, no-code, etc.
If they say "not sure" or "any", that's fine â€” move on.

**Q4 â€” Do you want to work autonomously (agent does everything) or
collaboratively (you stay in the loop)?**
1. Fully autonomous â€” just go
2. Collaborative â€” I want to review/approve steps
3. Not sure yet

---

### Step 3 â€” Recommend skills
...
**âœ… Primary Skill: `@skill-name`**
*Why:* [1â€“2 sentences explaining why this is the best fit for what they described]
*Invoke it like this:*
```
...
**ðŸ” Also consider:**
- `@skill-name-2` â€” [one sentence on when to layer this in]
- `@skill-name-3` â€” [one sentence on when to layer this in]

---

### Step 4 â€” Offer a ready-made prompt
...
Agent: No problem â€” let me ask a few quick questions.
...
Agent: What tech stack? (React, Node, Python, etc. â€” or "not sure")

User: Next.js

Agent: âœ… Primary Skill: @brainstorming
       ...
       ðŸ” Also consider:
       - @plan-writing â€” once brainstorming produces a spec, break it into tasks
       - @senior-fullstack â€” when you are ready to start building
...
- Primary: `@app-builder`
- If they want to plan first: `@brainstorming` â†’ `@plan-writing` â†’ `@app-builder`
...
- Full plan: `@plan-writing` â†’ `@executing-plans`
...
- Does not execute the recommended skill â€” it only recommends it. The user
