...
description: "Use when working with angular-state-management"
---
...
- You need React state management â†’ use `react-state-management`
...
```
Small app, simple state â†’ Signal Services
Medium app, moderate state â†’ Component Stores
Large app, complex state â†’ NgRx Store
Heavy server interaction â†’ NgRx Query + Signal Services
Real-time updates â†’ RxAngular + Signals
```
