...
description: "Use when working with nemotron-customize"
---
...
- For hosted services (translation, hosted eval): the auth environment variable
  ...
  environment â€” never inlined or committed.
...
- Output discipline (keeps responses tight): emit one command block per step,
  ...
  invented flags. Keep narrative to a few lines â€” the command plus the required
