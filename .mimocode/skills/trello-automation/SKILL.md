...
description: "Use when working with trello-automation"
---
...
**Pitfalls**:
- Some runs return boards under response.data.details[]â€”don't assume flat top-level array
- Lists may be nested under results[0].response.data.detailsâ€”parse defensively
...
- **Board name â†’ Board ID**: `TRELLO_GET_MEMBERS_BOARDS_BY_ID_MEMBER` with idMember='me'
- **List name â†’ List ID**: `TRELLO_GET_BOARDS_LISTS_BY_ID_BOARD` with resolved board ID
- **Card name â†’ Card ID**: `TRELLO_GET_SEARCH` with query string
- **Member name â†’ Member ID**: `TRELLO_GET_BOARDS_MEMBERS_BY_ID_BOARD`
