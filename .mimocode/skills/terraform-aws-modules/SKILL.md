...
description: "Use when working with terraform-aws-modules"
---

---
name: terraform-aws-modules
description: "Terraform module creation for AWS â€” reusable modules, state management, and HCL best practices. Use when building or reviewing Terraform AWS infrastructure."
risk: unknown
source: community
...
- âœ… **Do:** Pin provider versions in `versions.tf`
- âœ… **Do:** Use `terraform plan` output in PR reviews
- âœ… **Do:** Store state in S3 with DynamoDB locking and encryption
- âŒ **Don't:** Use `count` when resource identity matters â€” use `for_each`
- âŒ **Don't:** Commit `.tfstate` files to version control
