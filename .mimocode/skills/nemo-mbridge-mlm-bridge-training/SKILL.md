...
description: "Use when working with nemo-mbridge-mlm-bridge-training"
---
...
embeddings, `vocab_size` inherited from tokenizer) â€” matching MLM
...
iteration. Compare `lm loss` values from both logs â€” they should agree to
...
- `vanilla_gpt_pretrain_config` â€” Minimal GPT (bare GPTModelProvider defaults,
  ideal for correlation testing and custom configs)
- `llama32_1b_pretrain_config` â€” Llama 3.2 1B (16L, 2048H, GBS=512, seq=8192)
- `llama3_8b_pretrain_config` â€” Llama 3 8B
- `qwen3_8b_pretrain_config` â€” Qwen3 8B
- `deepseek_v2_lite_pretrain_config` â€” DeepSeek-V2-Lite 16B MoE
