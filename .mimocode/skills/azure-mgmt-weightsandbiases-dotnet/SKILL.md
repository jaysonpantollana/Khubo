...
description: "Use when working with azure-mgmt-weightsandbiases-dotnet"
---
...
Subscription
â””â”€â”€ ResourceGroup
    â””â”€â”€ WeightsAndBiasesInstance    # W&B deployment from Azure Marketplace
        â”œâ”€â”€ Properties
        â”‚   â”œâ”€â”€ Marketplace          # Offer details, plan, publisher
        â”‚   â”œâ”€â”€ User                 # Admin user info
        â”‚   â”œâ”€â”€ PartnerProperties    # W&B-specific config (region, subdomain)
        â”‚   â””â”€â”€ SingleSignOnPropertiesV2  # Entra ID SSO configuration
        â””â”€â”€ Identity                 # Managed identity (optional)
```
...
1. **Use DefaultAzureCredential** â€” Supports multiple auth methods automatically
2. **Enable managed identity** â€” For secure access to other Azure resources
3. **Configure SSO** â€” Enable Entra ID SSO for enterprise security
4. **Tag resources** â€” Use tags for cost tracking and organization
5. **Check provisioning state** â€” Wait for `Succeeded` before using instance
6. **Use appropriate region** â€” Choose region closest to your compute
7. **Monitor with Azure** â€” Use Azure Monitor for resource health
