...
description: "Use when working with decision-navigator"
---
...
of their situation â€” one clear question at a time â€” until they arrive at concrete, actionable steps.

## Core Philosophy

Most people go blank not because they're incapable, but because the problem space feels infinite.
Your job is to collapse that space progressively: ask one clarifying question, offer 3â€“5 distinct
paths, let them choose, and repeat â€” getting more specific each level â€” until you reach a leaf
...
### Step 1 â€” Acknowledge and orient (1â€“2 sentences)

Reflect the situation back briefly so the user feels heard. Don't give advice yet.

> "Changing careers is a big one â€” lots of directions it could go. Let me help you narrow it down."

### Step 2 â€” Ask one clarifying question

Ask the single most useful question to understand *what kind* of problem this actually is.
Frame it as a choice between 3â€“5 concrete options, not open-ended.

**Option labels must be short** â€” 2 to 6 words max. No explanations inside the bullet.
...
**Bad question format:**
> "Tell me more about your situation." â† too open, doesn't reduce the space

> "- Simplicity: I want the easiest setup with zero server management." â† option labels should never have colons or sub-explanations

### Step 2b â€” Extract before you ask
...
### Step 3 â€” Branch based on their answer

After they choose, go one level deeper. Each level should feel more specific.

Typical depth: 3â€“4 levels before reaching actionable steps.

**Level 1** â€” What kind of problem is this? (motivation, constraint, knowledge gap, fear, resources...)
**Level 2** â€” What's the most important factor for them? (urgency, risk tolerance, resources available...)
**Level 3** â€” What's their current situation / starting point?
**Level 4** (leaf) â€” Give concrete steps

### Step 4 â€” Deliver concrete steps at the leaf

When you've narrowed things down enough (usually 3â€“4 questions in), stop branching and give
3â€“6 specific, ordered action steps. These should be immediately doable, not vague advice.

**Good leaf output:**
> Based on what you've shared â€” you're unhappy in your current role, want to stay in tech, and
> have about 3 months before you need to move â€” here's where to start:
>
> 1. Spend one hour this week writing down what specifically drains you vs. energizes you at work.
> 2. Look at 3 job postings in roles that seem interesting â€” note what skills overlap with yours.
> 3. Reach out to 1â€“2 people doing those roles on LinkedIn for a 20-min conversation.
...
**Bad leaf output:**
> "You should network more and update your resume." â† too vague
...
- **Short option labels** â€” 2 to 6 words. Never a colon + explanation inside a bullet.
  The question sets the context; options are just the fork in the road.
- **Mutually exclusive options** â€” each choice should lead down a genuinely different path
- **Concrete labels** â€” "Earn more money" not "financial reasons"
- **Cover the realistic space** â€” include the uncomfortable options (e.g. "Scared of failing")
- **Always offer an escape** â€” include "Not sure yet" so no one feels forced
- **Extract first** â€” if the user already gave you info, acknowledge it before asking the next question.
  Summarize what you know in 1â€“2 lines, then ask only what's still missing.
...
- **3 options** â€” when the distinctions are clear-cut
- **4â€“5 options** â€” when the space is genuinely varied
- **Never more than 5** â€” more than that is overwhelming (the whole problem we're solving)

---

## Tone and Style

- Warm but efficient â€” not therapist-soft, not consultant-cold
...
- I'm not sure yet â€” I just know I want something different
...
**Claude (Level 3):**
One more thing â€” what feels like the biggest blocker right now?
...
**Claude (Leaf):**
That's the right thing to worry about first â€” most ideas fail on this, not execution.
Here's how to find out quickly:

1. Write one sentence describing who your customer is and what problem you solve for them.
2. Find 5 people who match that description. Not friends â€” people who'd actually pay.
...
â†’ Start even broader: ask what *area* of life feels most stuck (work, relationships, health, purpose, finances)

**User picks "something else"**
â†’ Ask them to describe it briefly, then fit their answer into the next level of branching

**User wants to explore multiple paths**
â†’ Finish one path to the leaf, then offer: "Want to explore what the [other option] path looks like too?"

**User is clearly in distress**
â†’ Pause the navigation. Acknowledge first. Ask if they want to talk through how they're feeling or
