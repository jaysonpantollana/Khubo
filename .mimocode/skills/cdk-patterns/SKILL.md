---
name: cdk-patterns
description: "Use when working with cdk-patterns"
---
...
- âœ… **Do:** Use `cdk.Tags.of(this).add()` for consistent tagging
- âœ… **Do:** Separate stateful and stateless resources into different stacks
- âœ… **Do:** Use `cdk diff` before every deploy
- âŒ **Don't:** Use L1 (`Cfn*`) constructs when L2 alternatives exist
- âŒ **Don't:** Hardcode account IDs or regions â€” use `cdk.Aws.ACCOUNT_ID`
