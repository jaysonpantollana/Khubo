...
description: "Use when working with tutorial-engineer"
---
 ...
 **Learning Retention Shortcuts:**
 ...
 |---------|-----------------|--------------|
 | Learn by Doing | +% vs reading | Every concept â†’ immediate practice |
 ...
 **Quick Check:** Can each concept be explained in - paragraphs?
 ...
 - Arrange in logical learning sequence (simple â†’ complex, concrete â†’ abstract)
 ...
 **Quick Check:** Does each exercise have a clear success criterion?
 ...
 - **Pattern:** I do (example) â†’ We do (guided) â†’ You do (challenge)
 ...
 **Pattern:** Each section should follow this rhythm:
 ...
 . **Troubleshooting**: Common errors and solutions (error message â†’ fix)
 ...
 **Speed Rules:** Apply these heuristics to write x faster with better outcomes.
 ...
 |-----------|------------------|---------|
 | Show, Don't Tell | Code first, explain after | Show function â†’ then explain parameters |
 | Fail Forward | Include - intentional errors per tutorial | "What happens if we remove this line?" |
 | Incremental Complexity | Each step adds â‰¤ new concept | Previous code + new feature = working |
 ...
 **Cognitive Load Management:**
 - **Â± Rule:** No more than  new concepts per section
 ...
 **Choose based on learning goal:**
 ...
 - **Workshop Series**: Multi-part progressive learning (Part : Basics â†’ Part : Advanced)
 ...
 **Pre-Publish Audit ( minutes):**
 ...
 - [ ] Is the time estimate accurate? (Within Â±% of actual completion time)
 ...
 **Template Structure (copy-paste ready):**
    ...
    [Explanation â†’ Example â†’ Practice pattern]
    ...
    â”‚ Error    â”‚ Cause     â”‚ Fix  â”‚
    â”œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¼â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¼â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¤
    â”‚ [Error message] â”‚ [Why it happens] â”‚ [Exact fix] â”‚
 ...
 **Accessibility Checklist:**
 ...
 - [ ] Headings are hierarchical (H â†’ H â†’ H)
