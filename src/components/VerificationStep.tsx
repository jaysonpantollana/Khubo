                ...
                <motion.button
                  ...
                  className={cn(
                    ...
                    isSelected
                      ...
                      : 'border-neutral-200 bg-white border-neutral-300 bg-neutral-50'
                  )}
                >
                  {isSelected && (
                    <motion.div
                ...
                <div
                  ...
                  className={cn(
                    ...
                    isDragOver
                      ...
                      : 'border-neutral-300 border-[#2252D6]/50 bg-neutral-50/50'
                  )}
                >
                ...
                <div className="border border-neutral-200 rounded-2xl overflow-hidden">
                  <div className="relative bg-neutral-50 flex items-center justify-center p-4 max-h-44 overflow-hidden">
                    ...
                    <button
                      ...
                      className="absolute top-2 right-2 p-1.5 bg-white/90 bg-red-50 rounded-full shadow-sm border border-neutral-200 transition-colors cursor-pointer"
                    >
                      <Trash2 size={14} className="text-red-400 text-red-500" />
                    </button>
                  </div>
