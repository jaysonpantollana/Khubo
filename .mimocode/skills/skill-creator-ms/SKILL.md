...
description: "Use when working with skill-creator-ms"
---
...
1. **Procedural knowledge** â€” Multi-step workflows for specific domains
2. **SDK expertise** â€” API patterns, authentication, error handling for Azure services
3. **Domain context** â€” Schemas, business logic, company-specific patterns
4. **Bundled resources** â€” Scripts, references, templates for complex tasks
...
1. **Metadata** (~100 words) â€” Always in context
2. **SKILL.md body** (<5k words) â€” When skill triggers
3. **References** (unlimited) â€” As needed
...
â””â”€â”€ Bundled Resources (optional)
    ...
    â””â”€â”€ assets/       â€” Output resources (templates, images)
```
...
1. **Title** â€” `# SDK Name`
2. **Installation** â€” `pip install`, `npm install`, etc.
3. **Environment Variables** â€” Required configuration
4. **Authentication** â€” Always `DefaultAzureCredential`
5. **Core Workflow** â€” Minimal viable example
6. **Feature Tables** â€” Clients, methods, tools
7. **Best Practices** â€” Numbered list
8. **Reference Links** â€” Table linking to `/references/*.md`
...
1. **Gather SDK Context** â€” User provides SDK/API reference (REQUIRED)
2. **Understand** â€” Research SDK patterns from official docs
3. **Plan** â€” Identify reusable resources and product area category
4. **Create** â€” Write SKILL.md in `.github/skills/<skill-name>/`
5. **Categorize** â€” Create symlink in `skills/<language>/<category>/`
6. **Test** â€” Create acceptance criteria and test scenarios
7. **Document** â€” Update README.md skill catalog
8. **Iterate** â€” Refine based on real usage
...
1. Azure service family (Storage â†’ `data`, Event Hubs â†’ `messaging`)
2. Primary use case (AI agents â†’ `foundry`)
...
#### âŒ INCORRECT: Wrong Module Path
\`\`\`python
...
#### âŒ INCORRECT: Hardcoded Credentials
\`\`\`python
...
1. **Update README.md** â€” Add the skill to the appropriate language section in the Skill Catalog
   ...
   - Update language section count (e.g., `> N skills â€¢ suffix: -py`)
   ...
   - Update test coverage table â€” update skill count, scenario count, and top skills for the language

2. **Regenerate GitHub Pages data** â€” Run the extraction script to update the docs site
   ```bash
...
3. **Verify AGENTS.md** â€” Ensure the skill count is accurate
...
```
azure-service-skill/
â”œâ”€â”€ SKILL.md (overview + language selection)
â””â”€â”€ references/
    â”œâ”€â”€ python.md
    â”œâ”€â”€ dotnet.md
    â”œâ”€â”€ java.md
