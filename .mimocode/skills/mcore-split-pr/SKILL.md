---
name: mcore-split-pr
description: "Use when working with mcore-split-pr"
---
...
2. Identify the largest cluster â€” this becomes the first (and usually largest) PR.
...
5. Each PR must be independently mergeable to main â€” no broken imports, no missing symbols. Backward-compatible aliases and re-export stubs in the first PR can make this possible.
