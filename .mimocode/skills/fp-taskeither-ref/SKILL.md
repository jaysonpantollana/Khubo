...
description: "Use when working with fp-taskeither-ref"
---
...
TE.tryCatch(asyncFn, toError)  // Promise â†’ TaskEither
TE.fromEither(either)    // Either â†’ TaskEither
```
...
// âœ… TaskEither - errors typed and composable
