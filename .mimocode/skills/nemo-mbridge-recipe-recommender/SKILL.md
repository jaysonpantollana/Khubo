...
description: "Use when working with nemo-mbridge-recipe-recommender"
---
...
# Auto Recipe â€” Recipe Index & Recommendation
...
## Recipe Unification (Coming Soon â€” PR #2803)
...
- Perf recipes move from `scripts/performance/configs/` â†’ `src/megatron/bridge/recipes/<family>/<model>_perf.py`
- Each perf recipe becomes a **self-contained Python function** (e.g. `llama3_8b_h100_bf16_pretrain_config()`)
- The old `WorkloadBaseConfig` â†’ `set_workload_base_configs` â†’ `get_perf_optimized_recipe` pipeline is removed
...
|--------|------|----|----|----|----|------------|---------|
| `llama2_7b_pretrain_config` | Pretrain | 2 | 1 | â€” | â€” | 2 | 4K |
| `llama3_8b_pretrain_config` | Pretrain | 2 | 1 | â€” | âœ“ | 2 | 8K |
| `llama3_8b_16k_pretrain_config` | Pretrain | 2 | 1 | 2 | âœ“ | 4 | 16K |
| `llama3_8b_64k_pretrain_config` | Pretrain | 2 | 1 | 4 | âœ“ | 8 | 64K |
| `llama3_8b_128k_pretrain_config` | Pretrain | 2 | 1 | 8 | âœ“ | 16 | 128K |
| `llama3_70b_pretrain_config` | Pretrain | 8 | 4 | â€” | âœ“ | 32 | 8K |
| `llama3_70b_16k_pretrain_config` | Pretrain | 8 | 4 | 2 | âœ“ | 64 | 16K |
| `llama3_70b_64k_pretrain_config` | Pretrain | 8 | 4 | 4 | âœ“ | 128 | 64K |
| `llama31_405b_pretrain_config` | Pretrain | 8 | 16 | â€” | âœ“ | 128 | 8K |
| `llama3_8b_sft_config` | SFT | 2 | 1 | â€” | âœ“ | 2 | 8K |
| `llama3_70b_sft_config` | SFT | 4 | 4 | â€” | âœ“ | 16 | 8K |
| `llama31_405b_sft_config` | SFT | 8 | 8 | â€” | âœ“ | 64 | 8K |
| `llama3_8b_peft_config` | PEFT | 1 | 1 | â€” | â€” | 1 | 8K |
| `llama3_70b_peft_config` | PEFT | 2 | 4 | â€” | âœ“ | 8 | 8K |
| `llama31_405b_peft_config` | PEFT | 4 | 8 | â€” | âœ“ | 32 | 8K |

### Qwen2 / Qwen2.5

| Recipe | Mode | TP | PP | Sizes |
|--------|------|----|----|-------|
| `qwen2_*_{pretrain,sft,peft}_config` | All | 1â€“8 | 1â€“4 | 500M, 1.5B, 7B, 14B, 32B, 72B |
| `qwen25_*_{pretrain,sft,peft}_config` | All | 1â€“8 | 1â€“4 | 500M, 1.5B, 3B, 7B, 14B, 32B, 72B |

### Qwen3 (Dense)

| Recipe | Mode | TP | PP | CP | Sizes |
|--------|------|----|----|-----|-------|
| `qwen3_*_pretrain_config` | Pretrain | 1â€“8 | 1â€“2 | â€” | 600Mâ€“32B |
| `qwen3_*_sft_config` | SFT | 1â€“8 | 1â€“2 | â€” | 600Mâ€“32B |
| `qwen3_600m_sft_128k_config` | SFT | 1 | 1 | 8 | 600M (128K seq) |
| `qwen3_*_peft_config` | PEFT | 1 | 1 | â€” | 600Mâ€“32B |

### Qwen3 MoE

| Recipe | Mode | TP | PP | EP | CP | GPUs |
|--------|------|----|----|----|----|------|
| `qwen3_30b_a3b_pretrain_config` | Pretrain | 1 | 1 | 8 | â€” | 8 |
| `qwen3_30b_a3b_sft_config` | SFT | 1 | 1 | 8 | â€” | 8 |
| `qwen3_30b_a3b_peft_config` | PEFT | 1 | 1 | 1 | â€” | 1 |
| `qwen3_235b_a22b_pretrain_config` | Pretrain | 4 | 16 | 8 | 2 | 512+ |
| `qwen3_235b_a22b_sft_config` | SFT | 4 | 8 | 8 | â€” | 256 |
| `qwen3_235b_a22b_peft_config` | PEFT | 1 | 4 | 4 | â€” | 16 |
...
| Recipe | Mode | TP | PP | Sizes |
|--------|------|----|----|-------|
| `gemma2_*_{pretrain,sft,peft}_config` | All | 2â€“8 | 1â€“2 | 2B, 9B, 27B |
...
|--------|------|----|----|-----|-------|
| `nemotronh_{4b,8b,47b,56b}_*_config` | P/S/PEFT | 1â€“8 | 1â€“4 | â€” | Dense SSM-hybrid |
...
| `nemotron_nano_{9b,12b}_v2_*_config` | P/S/PEFT | varies | 1 | â€” | Dense |
...
| Recipe | Mode | TP | PP | EP | GPUs |
|--------|------|----|----|-----|------|
| `gemma3_vl_{4b,12b,27b}_{sft,peft}_config` | SFT/PEFT | 1â€“8 | 1â€“2 | â€” | 1â€“16 |
| `qwen25_vl_{3b,7b,32b,72b}_{sft,peft}_config` | SFT/PEFT | 1â€“8 | 1â€“4 | â€” | 1â€“32 |
| `qwen3_vl_{8b,30b_a3b,235b_a22b}_{sft,peft}_config` | SFT/PEFT | 1â€“4 | 1â€“8 | 1â€“32 | 1â€“512 |
| `qwen35_vl_*_{sft,peft}_config` | SFT/PEFT | varies | varies | varies | varies |
| `glm_45v_{sft,peft}_config` | SFT/PEFT | 1 | 8 | 4â€“16 | 64â€“512 |
| `nemotron_nano_v2_vl_12b_{sft,peft}_config` | SFT/PEFT | 2â€“4 | 1 | â€” | 8 |
...
| Llama 3.1 405B | 128â€“1024 | H100, B200, B300, GB200, GB300 | TP+CP comm overlap (userbuffers), FSDP, heavy PP/VP |
...
| Model | GPUs | GPU Types | Key Features |
|-------|------|-----------|--------------|
| DeepSeek V3 (671B MoE) | 256â€“1024 | H100, B200, B300, GB200, GB300 | HybridEP dispatcher, MLA recompute, CUDA graphs (TE scoped) |

### Qwen3 MoE

| Model | GPUs | GPU Types | Key Features |
|-------|------|-----------|--------------|
| Qwen3 30B-A3B | 8â€“16 | H100, B200, B300, GB200, GB300 | MoE alltoall/flex dispatcher |
| Qwen3 235B-A22B | 64â€“256 | H100, B200, B300, GB200, GB300 | TP comm overlap, CUDA graphs, MoE a2a overlap |
| Qwen3-Next 80B-A3B | 64â€“128 | H100, B200, B300, GB200, GB300 | EP 64â€“128 |

### Qwen3-VL

| Model | GPUs | GPU Types | Key Features |
|-------|------|-----------|--------------|
| Qwen3-VL 30B-A3B | 8â€“16 | H100, B200, B300, GB200, GB300 | VLM + MoE |
| Qwen3-VL 235B-A22B | 64â€“256 | H100, B200, B300, GB200, GB300 | VLM + MoE, TP comm overlap |

### Kimi K2

| Model | GPUs | GPU Types | Key Features |
|-------|------|-----------|--------------|
| Kimi K2 (1T MoE) | 256â€“1024 | H100, B200, B300, GB200, GB300 | Muon/Adam optimizer, HybridEP, pipeline layout helpers |

### NemotronH

| Model | GPUs | GPU Types | Key Features |
|-------|------|-----------|--------------|
| Nemotron 3 Nano (30B MoE+Mamba) | 8â€“16 | H100, B200, B300, GB200, GB300 | TE CUDA graphs (attn+mamba+moe), HybridEP |
| Nemotron 3 Super | 64 | H100, B200, B300, GB200, GB300 | TE CUDA graphs, EP=64 |
| NemotronH 56B | 64 | H100, B200, B300 | TP=2â€“8, TE graphs (mamba+attn) |
...
â”‚
â”œâ”€ Know the model name?
â”‚   â”œâ”€ Yes â†’ Look up in Library Recipe Index above
â”‚   â”‚   â”œâ”€ Has a recipe for their size + mode? â†’ Use it directly
â”‚   â”‚   â””â”€ No exact match? â†’ Use closest size, adjust parallelism
â”‚   â””â”€ No â†’ Ask for model name, size, and HF model ID
â”‚
â”œâ”€ What's the training goal?
â”‚   â”œâ”€ Pretrain â†’ Use *_pretrain_config
â”‚   â”œâ”€ SFT (full fine-tune) â†’ Use *_sft_config
â”‚   â””â”€ PEFT (LoRA/DoRA) â†’ Use *_peft_config (lowest GPU requirement)
â”‚
â”œâ”€ How many GPUs?
â”‚   â”œâ”€ 1 GPU â†’ Only PEFT recipes work (TP=1, PP=1)
â”‚   â”œâ”€ 8 GPUs (1 node) â†’ Most 8Bâ€“16B models, small MoE (EP=8)
â”‚   â”œâ”€ 16â€“64 GPUs â†’ 70B dense, medium MoE
â”‚   â””â”€ 128+ GPUs â†’ 405B+, large MoE (DeepSeek V3, Kimi K2)
â”‚
â”œâ”€ Want throughput benchmarks?
â”‚   â”œâ”€ Yes â†’ Use perf recipes (scripts/performance/)
â”‚   â”‚   â””â”€ âš ï¸ These run on mock data for upper-bound perf only
â”‚   â””â”€ No â†’ Use library recipes (scripts/training/run_recipe.py)
â”‚
â””â”€ Long context?
    â”œâ”€ > 8K â†’ Need CP (context parallelism), check *_16k / *_64k / *_128k variants
    â””â”€ â‰¤ 8K â†’ Default recipes work
```
...
7. **world_size = DP Ã— TP Ã— PP Ã— CP Ã— EP.** DP is implicit. Make sure the
...
- `global_batch_size` determines learning dynamics. Scale with DP:
  `GBS = micro_batch_size Ã— DP Ã— gradient_accumulation_steps`.
...
| Fine-tune a 7-8B model | `llama3_8b_sft_config` or `qwen3_8b_sft_config` | 2â€“8 |
| LoRA on 1 GPU | `llama3_8b_peft_config` or `qwen3_8b_peft_config` | 1 |
| Pretrain a dense 70B | `llama3_70b_pretrain_config` | 32â€“64 |
| Train a small MoE | `qwen3_30b_a3b_pretrain_config` | 8 |
| Train a large MoE (235B+) | `qwen3_235b_a22b_pretrain_config` | 256â€“512 |
...
| VLM fine-tuning | `qwen3_vl_8b_sft_config` or `gemma3_vl_*_sft_config` | 4â€“8 |
