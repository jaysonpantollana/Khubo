...
description: "Use when working with local-legal-seo-audit"
---
...
2. **E-E-A-T & Trust Signals** (critical for YMYL â€” legal is a Your Money or Your Life category)
...
**Check for:**
- One page per distinct practice area (e.g., "Defesa Criminal", "PerÃ­cia Digital", "Laudo GrafotÃ©cnico")
...
- Primary keyword (e.g., "EscritÃ³rio de Advocacia Criminal em Belo Horizonte")
...
- OAB (Ordem dos Advogados do Brasil) â€” official listing
- Jusbrasil â€” attorney profile and articles
- Escavador â€” academic and professional profile
- ORCID â€” for forensic experts with publications
...
- Target "question" queries: "o que fazer quando", "quanto tempo demora", "qual a diferenÃ§a entre"
...
- Publish case-type explainers (e.g., "Como funciona uma perÃ­cia grafotÃ©cnica")
