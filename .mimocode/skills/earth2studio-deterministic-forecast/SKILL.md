...
description: "Use when working with earth2studio-deterministic-forecast"
---
...
`earth2studio/lexicon/<source>.py`. Common pairings: Global models â†’ GFS/ARCO/IFS;
Regional â†’ HRRR.
...
Example: 5-day forecast with 6h step â†’ `nsteps = 120 / 6 = 20`
