...
description: "Use when working with scientific-writing"
---

---
name: scientific-writing
description: "This is the core skill for the deep research and writing toolâ€”combining AI-driven deep research with well-formatted written outputs. Every document produced is backed by comprehensive literature search and verified citations through the research-lookup skill."
license: MIT license
metadata:
...
**âš ï¸ MANDATORY: Every scientific paper MUST include a graphical abstract plus 1-2 additional AI-generated figures using the scientific-schematics skill.**
...
```bash
python scripts/generate_schematic.py "Graphical abstract for [paper title]: [brief description showing workflow from input â†’ methods â†’ key findings â†’ conclusions]" -o figures/graphical_abstract.png
```
...
**âš ï¸ CRITICAL: Use BOTH scientific-schematics AND generate-image EXTENSIVELY throughout all documents.**
...
- Complex concept â†’ generate a schematic
- Data discussion â†’ generate a visualization
- Process description â†’ generate a flowchart
- Comparison â†’ generate a comparison diagram
- Reader benefit â†’ generate a visual
...
- âŒ **Never** leave bullet points in the final manuscript
- âŒ **Never** submit lists where paragraphs should be
- âŒ **Don't** use numbered or bulleted lists in Results or Discussion sections (except for specific cases like study hypotheses or inclusion criteria)
- âŒ **Don't** write sentence fragments or incomplete thoughts
...
- âŒ **NEVER** use labeled sections (Background:, Methods:, Results:, Conclusions:)
- âœ… **ALWAYS** write as flowing paragraph(s) with natural transitions
...
- Journal manuscripts â†’ Use `venue-templates` skill
- Conference papers â†’ Use `venue-templates` skill
- Academic theses â†’ Use institutional templates
...
| `\meansd{42.5}{8.3}` | 42.5 Â± 8.3 | Mean with SD |
