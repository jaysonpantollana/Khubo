...
description: "Use when working with keyword-extractor"
---
...
Jump to any section:
1. [CORE MANDATE](#core-mandate) â€“ Output rules and formatting 
2. [WHEN TO USE](#when-to-use) â€“ Trigger conditions for this skill 
3. [KEYWORD QUALITY RULES](#keyword-quality-rules) â€“ Priorities and forbidden keywords 
4. [WORKFLOW](#workflow) â€“ Step-by-step generation and processing 
5. [FAILURE HANDLING](#failure-handling) â€“ Short text or edge cases 
...
- mix of single words and 2â€“4 word phrases  
...
- Generating topic-specific keywords or tags based on the contentâ€™s main subjects and concepts  
