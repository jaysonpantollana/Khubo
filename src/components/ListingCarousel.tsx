...
const CAROUSEL_SCROLLER_CLASS =
  'flex overflow-x-auto no-scrollbar snap-x snap-mandatory scroll-smooth gap-3 pb-4';
    ...
    <div className="flex flex-col gap-2 md:gap-3">
      <div className="flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-3">
          <button
            onClick={() => scroll('left')}
            className="w-10 h-10 flex items-center justify-center rounded-full border border-neutral-200 bg-white text-neutral-600 border-neutral-400 text-black transition-all"
