...
description: "Use when working with tao-train-pose-classification"
---
...
Minimum 1 GPU(s), recommended 1 GPU(s). 8GB+ VRAM per GPU. Pose classification is very lightweight â€” skeleton data is small. Single GPU is sufficient.
