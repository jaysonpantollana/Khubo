...
description: "Use when working with seo-programmatic"
---
...
|--------|-----------|--------|
| Pages without content review | 100+ | âš ï¸ WARNING: require content audit before publishing |
| Pages without justification | 500+ | ðŸ›‘ HARD STOP: require explicit user approval and thin content audit |
| Unique content per page | <40% | âŒ Flag as thin content (likely penalty risk) |
| Word count per page | <300 | âš ï¸ Flag for review (may lack sufficient value) |
...
âœ… Integration pages (with real setup docs, API details, screenshots)
âœ… Template/tool pages (with downloadable content, usage instructions)
âœ… Glossary pages (200+ word definitions with examples, related terms)
âœ… Product pages (unique specs, reviews, comparison data)
âœ… Data-driven pages (unique statistics, charts, analysis per record)

### Penalty Risk (avoid at scale)
âŒ Location pages with only city name swapped in identical text
âŒ "Best [tool] for [industry]" without industry-specific value
âŒ "[Competitor] alternative" without real comparison data
âŒ AI-generated pages without human review and unique value-add
âŒ Pages where >60% of content is shared template boilerplate

### Uniqueness Calculation
Unique content % = (words unique to this page) / (total words on page) Ã— 100
...
|----------|--------|-------|
| Data Quality | âœ…/âš ï¸/âŒ | XX/100 |
| Template Uniqueness | âœ…/âš ï¸/âŒ | XX/100 |
| URL Structure | âœ…/âš ï¸/âŒ | XX/100 |
| Internal Linking | âœ…/âš ï¸/âŒ | XX/100 |
| Thin Content Risk | âœ…/âš ï¸/âŒ | XX/100 |
| Index Management | âœ…/âš ï¸/âŒ | XX/100 |
