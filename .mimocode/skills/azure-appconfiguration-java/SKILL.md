...
description: "Use when working with azure-appconfiguration-java"
---
...
1. **Use labels** â€” Separate configurations by environment (Dev, Staging, Production)
2. **Use snapshots** â€” Create immutable snapshots for releases
3. **Feature flags** â€” Use for gradual rollouts and A/B testing
4. **Secret references** â€” Store sensitive values in Key Vault
5. **Conditional requests** â€” Use ETags for optimistic concurrency
6. **Read-only protection** â€” Lock critical production settings
7. **Use Entra ID** â€” Preferred over connection strings
8. **Async client** â€” Use for high-throughput scenarios
