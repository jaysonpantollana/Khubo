      ...
      <div className="flex flex-wrap gap-2">
          {history.map((query) => (
            <button
              ...
              className="flex items-center gap-1.5 bg-neutral-100 dark:bg-neutral-800 bg-neutral-200 dark:bg-neutral-700 px-3 py-1.5 rounded-full text-xs font-medium text-neutral-800 dark:text-neutral-200 transition-colors"
            >
              {query}
              <span
                onClick={(e) => {
