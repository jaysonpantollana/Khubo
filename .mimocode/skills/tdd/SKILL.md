---
name: tdd
description: "Use when working with tdd"
---
...
- [ ] Identify opportunities for deep modules (small interface, deep implementation) â€” run the `/codebase-design` skill for the vocabulary and the testability checks
