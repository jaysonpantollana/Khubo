...
description: "Use when working with odoo-shopify-integration"
---
...
# Odoo â†” Shopify Integration

## Overview

This skill guides you through integrating Odoo with Shopify â€” syncing your product catalog, real-time inventory levels, incoming orders, and customer data. It covers both using the official Odoo Shopify connector (Enterprise) and building a custom integration via Shopify REST + Odoo XMLRPC APIs.
...
SHOPIFY                          ODOO
--------                         ----
Product Catalog <â”€â”€â”€â”€â”€â”€syncâ”€â”€â”€â”€â”€â”€  Product Templates + Variants
Inventory Level <â”€â”€â”€â”€â”€â”€syncâ”€â”€â”€â”€â”€â”€  Stock Quants (real-time)
New Order       â”€â”€â”€â”€â”€â”€â”€pushâ”€â”€â”€â”€â”€â”€> Sale Order (auto-confirmed)
Customer        â”€â”€â”€â”€â”€â”€â”€pushâ”€â”€â”€â”€â”€â”€> res.partner (created if new)
Fulfillment     <â”€â”€â”€â”€â”€â”€pushâ”€â”€â”€â”€â”€â”€  Delivery Order validated
```
...
- âœ… **Do:** Use Shopify's **webhook system** for real-time order sync instead of polling.
- âœ… **Do:** Match products using **SKU / Internal Reference** as the unique key between both systems.
- âœ… **Do:** Validate Shopify webhook HMAC signatures before processing any payload.
- âŒ **Don't:** Sync inventory from both systems simultaneously without a "master system" â€” pick one as the source of truth.
- âŒ **Don't:** Use Shopify product IDs as the key â€” use SKUs which are stable across platforms.
