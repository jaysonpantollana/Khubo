...
description: "Use when working with llm-prompt-optimizer"
---
...
- **R** â€” **Role**: Who is the AI in this interaction?
- **S** â€” **Situation**: What context does it need?
- **C** â€” **Constraints**: What are the rules and limits?
- **I** â€” **Instructions**: What exactly should it do?
- **T** â€” **Template**: What should the output look like?
...
Do not include any explanation or markdown â€” just the raw JSON object.
...
- âœ… **Do:** Always specify the output format (JSON, markdown, plain text, bullet list)
- âœ… **Do:** Use delimiters (```, ---) to separate instructions from content
- âœ… **Do:** Test prompts with edge cases (empty input, unusual data)
- âœ… **Do:** Version your system prompts in source control
- âœ… **Do:** Add "think step by step" for math, logic, or multi-step tasks
- âŒ **Don't:** Use negative-only instructions ("don't be verbose") â€” add positive alternatives
- âŒ **Don't:** Assume the model knows your codebase context â€” always include it
- âŒ **Don't:** Use the same prompt across different models without testing â€” they behave differently
