...
description: "Use when working with nemoclaw-user-reference"
---
...
- **[references/cli-selection-guide.md](references/cli-selection-guide.md)** â€” Explains when to use `$$nemoclaw` versus `openshell` for NemoClaw-managed sandboxes, including lifecycle, inference, policy, monitoring, file transfer, and gateway operations.
