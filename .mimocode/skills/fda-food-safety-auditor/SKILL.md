...
description: "Use when working with fda-food-safety-auditor"
---
...
3. **Analyze**: The AI identifies gaps â€” missing Critical Control Points (CCPs), inadequate monitoring parameters, or incomplete corrective action records.
...
**Scenario:** A pasteurizer temperature dropped below the critical limit of 161Â°F for 30 seconds. The operator brought it back up and logged â€œfixed temperature.â€ No product was quarantined.
...
Citation: 21 CFR 117.150 â€” Corrective Actions and Corrections
...
- âœ… **Do:** Provide exact monitoring logs with temperatures, pH values, or times.
- âœ… **Do:** Use this skill to practice mock FDA inspections before the real thing.
- âŒ **Don't:** Assume SSOPs (Sanitation Standard Operating Procedures) satisfy the same requirements as process preventive controls.
- âŒ **Don't:** Close a CCP deviation without completing a full product disposition.
