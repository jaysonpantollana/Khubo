...
description: "Use when working with azure-microsoft-playwright-testing-ts"
---
...
1. **Use Entra ID auth** â€” More secure than access tokens
2. **Provide explicit credential** â€” Always pass `credential: new DefaultAzureCredential()`
3. **Enable artifacts** â€” Set `trace: "on-first-retry"`, `video: "retain-on-failure"` in config
4. **Scale workers** â€” Use `--workers=20` or higher for parallel execution
5. **Region selection** â€” Choose region closest to your test targets
6. **HTML reporter first** â€” When using Azure reporter, list HTML reporter before Azure reporter
