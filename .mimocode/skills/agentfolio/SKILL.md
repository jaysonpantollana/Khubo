---
name: agentfolio
description: "Use when working with agentfolio"
---
...
2. **Search by intent**
   - Start from the problem you want to solve:  
     - â€œcustomer support agentsâ€  
     - â€œautonomous coding agentsâ€  
     - â€œresearch / analysis agentsâ€
...
- Define the problem: â€œautonomous test failure triage for CI pipelinesâ€.
- Use AgentFolio to search for:
  - â€œtesting agentâ€, â€œCI agentâ€, â€œDevOps assistantâ€, â€œincident triageâ€.
...
- If you plan to add a new skill (e.g., observability agent, security agent):
  ...
  - Extract 3â€“5 concrete patterns you want to emulate or avoid.
...
- â€œUse AgentFolio to find 3 autonomous AI agents focused on code review. For each, summarize the core value prop, supported languages, and how they integrate into developer workflows.â€
- â€œScan AgentFolio for agents that help with customer support triage. List the top options, their target customer size (SMB vs. enterprise), and any notable UX patterns.â€
- â€œBefore we build our own research assistant, use AgentFolio to map existing research / analysis agents and highlight gaps we could fill.â€
