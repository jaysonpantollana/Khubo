---
name: nemo-rl-docs
description: "Use when working with nemo-rl-docs"
---
...
When a new feature is added, update or create documentation in the `docs/` directory that most closely matches the feature. Look at existing docs to find the best fit â€” if none exists, create a new doc and add it to @docs/index.md.
