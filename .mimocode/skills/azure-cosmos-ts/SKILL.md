...
description: "Use when working with azure-cosmos-ts"
---
...
Data plane SDK for Azure Cosmos DB NoSQL API operations â€” CRUD on documents, queries, bulk operations.

> **âš ï¸ Data vs Management Plane**
...
â””â”€â”€ Database
    â””â”€â”€ Container
        â”œâ”€â”€ Items (documents)
        â”œâ”€â”€ Scripts (stored procedures, triggers, UDFs)
        â””â”€â”€ Conflicts
```
...
1. **Use AAD authentication** â€” Prefer `DefaultAzureCredential` over keys
2. **Always use parameterized queries** â€” Prevents injection, improves plan caching
3. **Specify partition key** â€” Avoid cross-partition queries when possible
4. **Use bulk operations** â€” For multiple writes, use `executeBulkOperations`
5. **Handle 429 errors** â€” Implement retry logic with exponential backoff
6. **Use ETags for concurrency** â€” Prevent lost updates in concurrent scenarios
7. **Close client on shutdown** â€” Call `client.dispose()` in cleanup
