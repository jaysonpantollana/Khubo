---
name: manifest
description: "Use when working with manifest"
---
...
- The default endpoint works for most users â€” only change it if self-hosting
- API keys always start with `mnfst_` â€” any other format is invalid
