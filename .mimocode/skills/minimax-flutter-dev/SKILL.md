...
description: "Use when working with minimax-flutter-dev"
---
...
metadata:
  ...
  category: mobile
  sources:
    - flutter-expert by Jeff Smolinski (https://github.com/Jeffallan/claude-skills) â€” Flutter expert skill framework
