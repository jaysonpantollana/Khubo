...
description: "Use when working with c4-architecture-c4-architecture"
---
...
- âœ… Every subdirectory has a corresponding c4-code-\*.md file
- âœ… All code-level documentation includes complete function signatures
- âœ… Components are logically grouped with clear boundaries
- âœ… All components have interface documentation
- âœ… Master component index created with relationship diagram
- âœ… Containers map to actual deployment units
- âœ… All container APIs documented with OpenAPI/Swagger specs
- âœ… Container diagram shows deployment architecture
- âœ… System context includes all personas (human and programmatic)
- âœ… User journeys documented for all key features
- âœ… All external systems and dependencies identified
- âœ… Context diagram shows system, users, and external systems
- âœ… Documentation is organized in C4-Documentation/ directory

## Output Structure

```
C4-Documentation/
â”œâ”€â”€ c4-code-*.md              # Code-level docs (one per directory)
â”œâ”€â”€ c4-component-*.md          # Component-level docs (one per component)
â”œâ”€â”€ c4-component.md            # Master component index
â”œâ”€â”€ c4-container.md            # Container-level docs
â”œâ”€â”€ c4-context.md              # Context-level docs
â””â”€â”€ apis/                      # API specifications
    â”œâ”€â”€ [container]-api.yaml   # OpenAPI specs for each container
    â””â”€â”€ ...
```
