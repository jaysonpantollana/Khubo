...
description: "Use when working with apify-ultimate-scraper"
---
...
|----------|--------|--------|
| **Lead enrichment** | `compass/crawler-google-places` â†’ | `vdrmota/contact-info-scraper` |
| **Influencer vetting** | `apify/instagram-profile-scraper` â†’ | `apify/instagram-comment-scraper` |
| **Competitor deep-dive** | `apify/facebook-pages-scraper` â†’ | `apify/facebook-posts-scraper` |
| **Local business analysis** | `compass/crawler-google-places` â†’ | `compass/Google-Maps-Reviews-Scraper` |
