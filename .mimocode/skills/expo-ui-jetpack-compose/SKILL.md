...
description: "Use when working with expo-ui-jetpack-compose"
---
...
- **Icon** â€” Use `<Icon source={require('./icon.xml')} size={24} />` with Android XML vector drawables from [Material Symbols](https://fonts.google.com/icons).
