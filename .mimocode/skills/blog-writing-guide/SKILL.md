...
description: "Use when working with blog-writing-guide"
---

---
name: blog-writing-guide
description: "This skill enforces Sentry's blog writing standards across every post â€” whether you're helping an engineer write their first blog post or a marketer draft a product announcement."
risk: unknown
source: community
...
This skill enforces Sentry's blog writing standards across every post â€” whether you're helping an engineer write their first blog post or a marketer draft a product announcement.
...
**We sound like:** A senior developer at a conference afterparty explaining something they're genuinely excited about â€” smart, specific, a little irreverent, deeply knowledgeable.
...
- "We're excited/thrilled to announce" â€” just announce it
- "Best-in-class" / "industry-leading" / "cutting-edge" â€” show, don't tell
- "Seamless" / "seamlessly" â€” nothing is seamless
- "Empower" / "leverage" / "unlock" â€” say what you actually mean
- "Robust" â€” describe what makes it robust instead
- "At [Company], we believe..." â€” just state the belief
- "Streamline" â€” everyone is streamlining, stop
- Filler transitions: "That being said," "It's worth noting that," "At the end of the day," "Without further ado," "As you might know"
- "In this blog post, we will explore..." â€” be direct, just start
...
2. **How does it actually work?** Not buttons-you-click, but underlying technology. (Bulk of the post â€” be specific)
...
- Good: "This reduced our p99 error processing time from 340ms to 45ms â€” a 7.5Ã— improvement."
...
**Honesty over hype.** Never overstate what a feature does. Acknowledge limitations. If something is in beta, say so. If a competitor does something well, it's okay to note that. Do not claim AI features are more capable than they are â€” "Seer suggests a likely root cause" â‰  "Seer finds the root cause."
...
End with something useful â€” a link to docs, a way to try it, a call to give feedback. Never end with generic hype ("We can't wait to see what you build!") or recaps of what you just said.
