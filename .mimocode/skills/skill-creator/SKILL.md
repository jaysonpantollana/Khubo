---
name: skill-creator
description: "Use when working with skill-creator"
---
...
â•‘     ðŸ› ï¸  SKILL CREATOR - Creating New Skill                  â•‘
â• â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•£
...
**Expected output:**
```
ðŸ” Validating YAML frontmatter...
...
ðŸ“¦ Skill Name: your-skill-name
ðŸ“ Location: .github/skills/your-skill-name/
ðŸ”— Installed: Global (Copilot + Claude)
...
```
âŒ Error: Template not found at resources/templates/
