...
description: "Use when working with earth2studio-install"
---
...
for their use case â€” do not write inference code, do not compose
workflows.
...
special build notes. The workflow below is structural guidance â€” the
...
1. **Package manager** â€” uv (recommended) or pip? If unsure, recommend
   uv and link <https://docs.astral.sh/uv/getting-started/installation/>
2. **Project context** â€” new project or adding to existing?
3. **Python version** â€” recommend the version from the docs
   (currently 3.13)
...
plans to do â€” don't dump all options unprompted. Categories from the
docs:
...
The exact list comes from the live docs â€” cite those, not this table.
...
Mention environment variables the user might want to set â€” only if
