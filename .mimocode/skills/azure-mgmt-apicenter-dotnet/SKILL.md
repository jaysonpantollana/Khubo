...
description: "Use when working with azure-mgmt-apicenter-dotnet"
---
...
Subscription
â””â”€â”€ ResourceGroup
    â””â”€â”€ ApiCenterService                    # API inventory service
        â”œâ”€â”€ Workspace                       # Logical grouping of APIs
        â”‚   â”œâ”€â”€ Api                         # API definition
        â”‚   â”‚   â””â”€â”€ ApiVersion              # Version of the API
        â”‚   â”‚       â””â”€â”€ ApiDefinition       # OpenAPI/GraphQL/etc specification
        â”‚   â”œâ”€â”€ Environment                 # Deployment target (dev/staging/prod)
        â”‚   â””â”€â”€ Deployment                  # API deployed to environment
        â””â”€â”€ MetadataSchema                  # Custom metadata definitions
```
...
1. **Organize with workspaces** â€” Group APIs by team, domain, or product
2. **Use metadata schemas** â€” Define custom properties for governance
3. **Track lifecycle stages** â€” Keep API status current (design â†’ production â†’ deprecated)
4. **Document environments** â€” Include onboarding instructions and portal URIs
5. **Version consistently** â€” Use semantic versioning for API versions
6. **Import specifications** â€” Upload OpenAPI/GraphQL specs for discovery
7. **Link deployments** â€” Connect APIs to their runtime environments
8. **Use managed identity** â€” Enable SystemAssigned identity for secure integrations
