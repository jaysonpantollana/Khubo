...
description: "Use when working with seo-forensic-incident-response"
---
...
1. **Incident Description**
   ...
   - Was it sudden (1â€“3 days) or gradual (weeks)?
...
3. **Recent Changes Checklist**
   Ask explicitly about the 30â€“60 days before the drop:
...
- Plot clicks, impressions, CTR, and average position over the last 6â€“12 months.
- Identify:
...
- **Step-like drop** â†’ technical issue, manual action, deployment.
- **Gradual slide** â†’ quality issues, competitor improvements, algorithmic re-evaluation.
...
Look for patterns:
- Only mobile affected â†’ potential mobile UX, CWV, or mobile-only indexing issue.
- Specific country affected â†’ geo-targeting, hreflang, local factors.
- Non-branded hit harder than branded â†’ often algorithm/quality-related.
...
- **Hypothesis**: e.g., â€œA recent deployment introduced noindex tags on key templates.â€
...
3. Was there any redesign, migration, or major plugin/CMS update in the last 30â€“60 days?
