...
description: "Use when working with burpsuite-project-parser"
---
...
2. In Burp Suite: Extender â†’ Extensions â†’ Add
...
|----------|----------------|
| "This regex looks good" | Verify on sample data firstâ€”encoding and escaping cause silent failures |
...
| "Burp found it, so it's a vuln" | Burp findings require manual verificationâ€”they indicate potential issues, not proof |
