...
description: "Use when working with minimax-pptx-generator"
---
...
## Creating from Scratch â€” Workflow

**Use when no template or reference presentation is available.**

### Step 1: Research & Requirements

Search to understand user requirements â€” topic, audience, purpose, tone, content depth.
...
Classify **every slide** as exactly one of the [5 page types](references/slide-types.md). Plan the content and layout for each slide. Ensure visual variety â€” do NOT repeat the same layout across slides.
...
```
slides/
â”œâ”€â”€ slide-01.js          # Slide modules
â”œâ”€â”€ slide-02.js
â”œâ”€â”€ ...
â”œâ”€â”€ imgs/                # Images used in slides
...
- `pip install "markitdown[pptx]"` â€” text extraction
- `npm install -g pptxgenjs` â€” creating from scratch
- `npm install -g react-icons react react-dom sharp` â€” icons (optional)
