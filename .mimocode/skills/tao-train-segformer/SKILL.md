...
description: "Use when working with tao-train-segformer"
---
...
- [tao-deploy-segformer](references/tao-deploy-segformer.md) â€” SegFormer deploy workflow for TensorRT engine generation, TensorRT evaluation, and TensorRT inference using TAO Deploy.
