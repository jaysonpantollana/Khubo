...
description: "Use when working with seo-aeo-content-quality-auditor"
---
...
Runs a dual SEO + AEO audit on any landing page or blog post. Produces an overall score, SEO score, AEO score, and readability score â€” each out of 100 â€” with severity-ranked issue lists (Critical / Warning / Polish), exact fix instructions for every issue, and projected scores after all fixes are applied.
...
| Score | Status | Label |
|-------|--------|-------|
| 85â€“100 | âœ… Pass | Strong |
| 70â€“84 | âš ï¸ Warn | Acceptable |
| 50â€“69 | ðŸ”¶ Weak | Needs work |
| 0â€“49 | âŒ Fail | Do not publish |

## Examples

### Example: Audit Summary
Overall Score:    84/100  âš ï¸ Acceptable
SEO Score:        88/100  âœ… Pass
AEO Score:        74/100  âš ï¸ Acceptable
Readability:      91/100  âœ… Pass
Verdict: Strong SEO foundation. AEO needs a TL;DR block
and one more FAQ entry before publishing.
ðŸ”´ Critical (fix before publishing):

AEO: No TL;DR block found
Fix: Add a 2â€“3 sentence direct-answer block in a
blockquote immediately after the H1.

ðŸŸ¡ Important (fix soon):
2. AEO: FAQ has 3 entries â€” minimum is 4
Fix: Add one more FAQ entry using a secondary keyword
as the question.
Projected score after fixes: 93/100 âœ…

## Best Practices

- âœ… **Do:** Fix all Critical issues before publishing â€” they block AEO extraction
- âœ… **Do:** Use the projected score to prioritise which fixes to make first
- âœ… **Do:** Run the audit on both the landing page and blog post in the same session
- âŒ **Don't:** Publish content scoring below 50/100 overall
- âŒ **Don't:** Ignore AEO warnings â€” they directly affect AI engine citation probability
...
- `@seo-aeo-blog-writer` â€” produces the content this skill audits
- `@seo-aeo-landing-page-writer` â€” produces landing pages this skill audits
- `@seo-aeo-schema-generator` â€” uses audit output to determine schema priorities
