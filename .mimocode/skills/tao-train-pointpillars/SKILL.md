...
description: "Use when working with tao-train-pointpillars"
---

---
name: tao-train-pointpillars
description: PointPillars for 3D object detection from LiDAR point clouds. Encodes point clouds into a pseudo-image via a
  pillar-based representation, then applies 2D detection â€” used in autonomous driving and robotics. Use when training,
...
- [tao-deploy-pointpillars](references/tao-deploy-pointpillars.md) â€” PointPillars deploy workflow for TensorRT engine generation, TensorRT evaluation, and TensorRT inference using TAO Deploy.
