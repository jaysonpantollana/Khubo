...
description: "Use when working with azure-mgmt-botservice-dotnet"
---
...
â””â”€â”€ SubscriptionResource
    â””â”€â”€ ResourceGroupResource
        â””â”€â”€ BotResource
            â”œâ”€â”€ BotChannelResource (DirectLine, Teams, Slack, etc.)
            â”œâ”€â”€ BotConnectionSettingResource (OAuth connections)
            â””â”€â”€ BotServicePrivateEndpointConnectionResource
```
...
1. **Always use `DefaultAzureCredential`** â€” supports multiple auth methods
...
5. **Store MSA App credentials securely** â€” use Key Vault for secrets
