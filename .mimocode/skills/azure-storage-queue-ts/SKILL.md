...
description: "Use when working with azure-storage-queue-ts"
---
...
SDK for Azure Queue Storage operations â€” send, receive, peek, and manage messages in queues.
...
â””â”€â”€ QueueClient (queue level)
    â””â”€â”€ Messages (send, receive, peek, delete)
```
...
2. **Always delete after processing** â€” Prevent duplicate processing
3. **Handle poison messages** â€” Move failed messages to a dead-letter queue
4. **Use appropriate visibility timeout** â€” Set based on expected processing time
5. **Extend visibility for long tasks** â€” Update message to prevent timeout
6. **Use JSON for structured data** â€” Serialize objects to JSON strings
7. **Check dequeueCount** â€” Detect repeatedly failing messages
8. **Use batch receive** â€” Receive multiple messages for efficiency
