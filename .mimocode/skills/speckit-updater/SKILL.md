...
description: "Use when working with speckit-updater"
---
...
- **Step 1**: Outputs summary â†’ script exits â†’ waits for approval
- **Step 2**: After approval, Claude re-invokes with `-Proceed` â†’ applies updates
