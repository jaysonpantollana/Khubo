...
description: "Use when working with semgrep-rule-variant-creator"
---
...
â”œâ”€â”€ <original-rule-id>-<language>.yaml     # Ported Semgrep rule
â””â”€â”€ <original-rule-id>-<language>.<ext>    # Test file with annotations
```

Example output for porting `sql-injection` to Go and Java:
```
sql-injection-golang/
â”œâ”€â”€ sql-injection-golang.yaml
â””â”€â”€ sql-injection-golang.go

sql-injection-java/
â”œâ”€â”€ sql-injection-java.yaml
â””â”€â”€ sql-injection-java.java
```
...
FOR EACH target language:
  Phase 1: Applicability Analysis â†’ Verdict
...
**Verdict options:**
- `APPLICABLE` â†’ Proceed with variant creation
- `APPLICABLE_WITH_ADAPTATION` â†’ Proceed but significant changes needed
- `NOT_APPLICABLE` â†’ Skip this language, document why
