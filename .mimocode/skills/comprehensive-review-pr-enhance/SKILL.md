...
description: "Use when working with comprehensive-review-pr-enhance"
---
...
- **Risk level**: low / medium / high â€” because ___
```
...
- `resources/implementation-playbook.md` â€” Python helpers for automated PR analysis, coverage reports, and risk scoring
