---
name: claude-api
description: "Use when working with claude-api"
---
...
7. **`shared/error-codes.md`** â€” Read when debugging HTTP errors or implementing error handling.
8. **`shared/live-sources.md`** â€” WebFetch URLs for fetching the latest official documentation.
