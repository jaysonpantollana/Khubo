...
description: "Use when working with swift-concurrency-expert"
---
...
- Run the test suite to check for regressions â€” concurrency changes can introduce subtle runtime issues even when the build is clean.
...
**UI-bound type â€” adding `@MainActor`**
...
```swift
// Before: compiler error â€” SomeProtocol method is nonisolated but the
