      ...
      <div className="flex flex-col gap-2">
        {popular.map((item, idx) => (
          <button
            ...
            className="text-xs sm:text-[13px] font-bold bg-[#17294F] text-white px-3 py-1.5 rounded-full transition-all duration-150 w-fit flex items-center gap-1.5 cursor-pointer focus-visible:outline-none"
          >
            <Search size={11} />
            {item}
          </button>
