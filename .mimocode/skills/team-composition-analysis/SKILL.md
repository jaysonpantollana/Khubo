...
description: "Use when working with team-composition-analysis"
---
...
```
Total Comp = Base Salary Ã— 1.30 (benefits & taxes) + Equity Value
```
...
â”œâ”€â”€ Contractors
â””â”€â”€ First hires (report to founders)
```

**Seed:**
```
CEO
â”œâ”€â”€ Engineering Lead (2-4 engineers)
â”œâ”€â”€ Sales/Growth Lead (1-2 reps)
...
```
CEO
â”œâ”€â”€ CTO / VP Engineering (6-20 people)
â”‚   â”œâ”€â”€ Engineering Manager(s)
â”‚   â””â”€â”€ Individual Contributors
â”œâ”€â”€ VP Sales (5-15 people)
â”‚   â”œâ”€â”€ Sales Manager
â”‚   â”œâ”€â”€ Account Executives
â”‚   â””â”€â”€ SDRs
â”œâ”€â”€ Head of Product (2-5 people)
â”‚   â”œâ”€â”€ Product Managers
â”‚   â””â”€â”€ Designers
â”œâ”€â”€ Head of Customer Success (2-5 people)
â””â”€â”€ CFO / Finance Lead (2-5 people)
    â”œâ”€â”€ Recruiter
    â””â”€â”€ Operations
```
...
```
Total Comp Budget = Î£ (Role Count Ã— Fully-Loaded Cost Ã— % of Year)

Example:
3 Engineers Ã— $202K Ã— 100% = $606K
2 AEs Ã— $230K Ã— 75% (mid-year start) = $345K
1 PM Ã— $162K Ã— 100% = $162K
Total: $1.1M
```
...
6. **Calculate budget** - Fully-loaded cost Ã— headcount
