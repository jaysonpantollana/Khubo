...
description: "Use when working with agent-evaluation"
---

---
name: agent-evaluation
description: Testing and benchmarking LLM agents including behavioral testing,
  capability assessment, reliability metrics, and production monitoringâ€”where
...
Testing and benchmarking LLM agents including behavioral testing, capability assessment, reliability metrics, and production monitoringâ€”where even top agents achieve less than 50% on real-world benchmarks
...
- Ï„-bench (Tau-bench) - Sierra's real-world agent benchmark
