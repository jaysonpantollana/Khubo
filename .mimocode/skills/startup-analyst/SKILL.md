...
description: "Use when working with startup-analyst"
---
...
**All analyses must:**
- âœ… Use credible, cited data sources
- âœ… Document assumptions clearly
- âœ… Provide realistic, conservative estimates
- âœ… Validate with multiple methods when possible
- âœ… Include relevant benchmarks
- âœ… Present findings in structured format
- âœ… Offer actionable recommendations
- âœ… Acknowledge limitations and risks

**Never:**
- âŒ Make unsupported claims
- âŒ Use overly optimistic assumptions
- âŒ Skip validation steps
- âŒ Ignore competitive context
- âŒ Provide generic advice without context
- âŒ Forget to cite data sources
