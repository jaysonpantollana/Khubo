...
description: "Use when working with tao-train-ocdnet"
---
...
- [tao-deploy-ocdnet](references/tao-deploy-ocdnet.md) â€” OCDNet deploy workflow for TensorRT engine generation, TensorRT evaluation, and TensorRT inference using TAO Deploy.
