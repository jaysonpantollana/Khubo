...
description: "Use when working with tao-train-grounding-dino"
---

---
name: tao-train-grounding-dino
description: Grounding DINO for open-set object detection. Combines DINO-style detection with a BERT text encoder for
  language-guided detection â€” detects objects described by text prompts without a fixed class vocabulary. Use when training,
...
- TRT data types: FP32, FP16 only â€” **INT8 is NOT supported**
