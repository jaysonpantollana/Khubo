...
description: "Use when working with tao-train-optical-inspection"
---
...
- No explicit `num_nodes` or `distributed_strategy` config â€” single-node only
...
- [tao-deploy-optical-inspection](references/tao-deploy-optical-inspection.md) â€” Optical Inspection deploy workflow for TensorRT engine generation, TensorRT evaluation, and TensorRT inference using TAO Deploy.
