...
description: "Use when working with audit-context-building"
---
...
- Continuously link insights â†’ functions â†’ modules â†’ entire system.
...
## 3. Phase 1 â€” Initial Orientation (Bottom-Up Scan)
...
## 4. Phase 2 â€” Ultra-Granular Function Analysis (Default Mode)
...
- Track flow of data, assumptions, and invariants:
  caller â†’ callee â†’ return â†’ caller.
- Note if callee logic behaves differently in this specific call context.

#### External Calls â€” Two Cases

**Case A â€” External Call to a Contract Whose Code Exists in the Codebase**
...
**Case B â€” External Call Without Available Code (True External / Black Box)**
...
## 5. Phase 3 â€” Global System Understanding
