---
name: page-cro
description: "Use when working with page-cro"
---
...
## ðŸ”¢ Page Conversion Readiness & Impact Index
...
#### 1. Value Proposition Clarity (0â€“25)

* Visitor understands what this is and why it matters in â‰¤5 seconds
* Primary benefit is specific and differentiated
* Language reflects user intent, not internal jargon

---

#### 2. Conversion Goal Focus (0â€“20)
...
#### 3. Trafficâ€“Message Match (0â€“15)
...
#### 4. Trust & Credibility Signals (0â€“15)
...
#### 6. Objection Handling (0â€“10)

* Likely objections are anticipated
* Page addresses â€œWill this work for me?â€
...
| ------ | ------------------------ | ---------------------------------------------- |
| 85â€“100 | **High Readiness**       | Page is structurally sound; test optimizations |
| 70â€“84  | **Moderate Readiness**   | Fix key issues before testing                  |
| 55â€“69  | **Low Readiness**        | Foundational problems limit conversions        |
...
* **signup-flow-cro** â€“ If drop-off occurs after the page
* **form-cro** â€“ If the form is the bottleneck
* **popup-cro** â€“ If overlays are considered
* **copywriting** â€“ If messaging needs a full rewrite
* **ab-test-setup** â€“ For test execution and instrumentation
