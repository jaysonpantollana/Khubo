...
description: "Use when working with options-flow-analyzer"
---

---
name: options-flow-analyzer
description: Real vs lottery call separation for options P/C ratio analysis â€” prevents signal inversion from deep OTM noise
category: finance
risk: safe
source: community
...
Analyze options chain data with real vs lottery call separation â€” the key insight that prevents P/C ratio misinterpretation. Uses Polygon.io API.
...
```
Options Flow Summary â€” 2026-05-13
...
ANOMALIES:
XLI: P/C 5.32 vs 30-day baseline 0.87 â€” 4.5 std deviations above normal
RXRX: 84% lottery calls â€” raw P/C signal completely inverted after filtering
```
...
**Full bundle â€” $29 one-time**: Real/lottery separation + anomaly detection + per-expiry + unlimited tickers
