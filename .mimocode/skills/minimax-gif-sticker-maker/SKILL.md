...
description: "Use when working with minimax-gif-sticker-maker"
---
...
- **Custom**: Collect 4 short captions (1â€“3 words). Actions auto-match caption meaning.
...
1. Analyze the user's photo â€” identify subject type (person / animal / object / logo).
...
4. Generate (all 4 are independent â€” **run concurrently**):
...
### Step 2: Animate Each Image â†’ Video
...
All 4 calls are independent â€” **run concurrently**.

### Step 3: Convert Videos â†’ GIF
...
- Captions MUST come from [captions.md](references/captions.md) matching user's language column â€” never mix languages
