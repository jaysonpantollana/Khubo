...
description: "Use when working with antigravity-skill-orchestrator"
---
...
- âœ… **Do:** Always evaluate task complexity *before* looking for skills.
- âœ… **Do:** Keep the number of orchestrated skills as small as possible.
- âœ… **Do:** Use highly descriptive keys when running `memory_write` so they are easy to search later.
- âŒ **Don't:** Use this skill for simple bug fixes or UI tweaks.
- âŒ **Don't:** Combine skills that have overlapping and conflicting instructions without a clear plan to resolve the conflict.
- âŒ **Don't:** Attempt to construct, generate, or create new skills. Only combine what is available.
