...
description: "Use when working with startup-business-analyst-market-opportunity"
---
...
4. Calculate TAM: Î£ (Segment Size Ã— ACV)
...
Formula:
```
SAM = TAM Ã— Geographic % Ã— Product Fit % Ã— Market Readiness %
```
...
â†’ "AI-powered email marketing for e-commerce companies"

Who are your target customers?
â†’ "E-commerce companies with $1M+ annual revenue in North America"

What's your pricing model?
â†’ "Subscription: $50-500/month based on email volume, average $300/month"
