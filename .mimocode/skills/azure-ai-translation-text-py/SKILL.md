...
description: "Use when working with azure-ai-translation-text-py"
---
...
1. **Batch translations** â€” Send multiple texts in one request (up to 100)
2. **Specify source language** when known to improve accuracy
3. **Use async client** for high-throughput scenarios
4. **Cache language list** â€” Supported languages don't change frequently
