---
name: nv-segment-ct
description: "Use when working with nv-segment-ct"
---
...
runtime deps** â€” its documented command installs everything it needs.
...
step is also part of the contract â€” it pulls the ~832 MB model bundle
