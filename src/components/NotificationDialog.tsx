    ...
    >
      ...
      {notifications.length === 0 ? (
        ...
        <div className="divide-y divide-neutral-50">
          {notifications.map((n) => {
            ...
            return (
              <div key={n.id} className="flex items-start gap-3 p-4 bg-neutral-50 transition-colors">
      ...
      {notifications.length > 0 && (
        <div className="p-4 border-t border-neutral-100 shrink-0">
          <button
            onClick={onClear}
            className="w-full py-2.5 text-sm font-semibold text-red-500 bg-red-50 rounded-xl transition-colors"
          >
