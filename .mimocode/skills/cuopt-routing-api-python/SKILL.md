...
description: "Use when working with cuopt-routing-api-python"
---

---
name: cuopt-routing-api-python
version: "26.08.00"
description: Vehicle routing (VRP, TSP, PDP) with cuOpt â€” Python API only. Use when the user is building or solving routing in Python.
license: Apache-2.0
metadata:
...
| `compute_waypoint_sequence` alters route_df | It replaces the `location` column with waypoint ids in place â€” pass `route_df.copy()` if you still need cost-matrix indices (e.g. when iterating per truck) |
...
- [examples.md](references/examples.md) â€” VRP, PDP, multi-depot
- [server_examples.md](references/server_examples.md) â€” REST client (curl, Python)
- **Reference models:** This skill's `assets/` â€” [vrp_basic](assets/vrp_basic/), [pdp_basic](assets/pdp_basic/). See [assets/README.md](assets/README.md).
