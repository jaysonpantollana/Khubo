---
name: dotnet-backend
description: "Use when working with dotnet-backend"
---
...
- âœ… Entity Framework migrations (Add-Migration, Update-Database)
- âœ… Global exception handling middleware
- âœ… FluentValidation for complex validation
- âœ… Serilog for structured logging
- âœ… Health checks (AddHealthChecks)
- âœ… API versioning
- âœ… Swagger/OpenAPI documentation
- âœ… AutoMapper for DTO mapping
- âœ… CQRS with MediatR (for complex domains)
