---
name: lex
description: "Use when working with lex"
---
...
- âœ… **Trust but Verify**: Always include the links provided by `lex verify` in your output.
- âœ… **Table Formatting**: Use tables when comparing results across multiple jurisdictions.
- âŒ **No Guessing**: If a jurisdiction is outside the US/EU/CA scope, state that it is outside the LEX "Truth Engine" coverage.
- âŒ **No Anecdotal Advice**: Stick strictly to the findings in the templates or verified government domains.
