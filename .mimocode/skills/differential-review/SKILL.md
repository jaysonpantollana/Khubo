...
description: "Use when working with differential-review"
---
...
```
Pre-Analysis â†’ Phase 0: Triage â†’ Phase 1: Code Analysis â†’ Phase 2: Test Coverage
    â†“              â†“                    â†“                        â†“
Phase 3: Blast Radius â†’ Phase 4: Deep Context â†’ Phase 5: Adversarial â†’ Phase 6: Report
```
...
```
â”œâ”€ Need detailed phase-by-phase methodology?
â”‚  â””â”€ Read: methodology.md
â”‚     (Pre-Analysis + Phases 0-4: triage, code analysis, test coverage, blast radius)
â”‚
â”œâ”€ Analyzing HIGH RISK change?
â”‚  â””â”€ Read: adversarial.md
â”‚     (Phase 5: Attacker modeling, exploit scenarios, exploitability rating)
â”‚
â”œâ”€ Writing the final report?
â”‚  â””â”€ Read: reporting.md
â”‚     (Phase 6: Report structure, templates, formatting guidelines)
â”‚
â”œâ”€ Looking for specific vulnerability patterns?
â”‚  â””â”€ Read: patterns.md
â”‚     (Regressions, reentrancy, access control, overflow, etc.)
â”‚
â””â”€ Quick triage only?
   â””â”€ Use Quick Reference above, skip detailed docs
```
