...
description: "Use when working with youtube-seo-optimizer"
---

---
name: youtube-seo-optimizer
description: >
  Generate complete YouTube & podcast SEO packages with live-researched keywords â€”
...
- Use this for any video or podcast SEO request â€” new, already published, or short-form

## Overview

You need web search + URL fetch for this to work. Whatever your host calls them â€” `web_search`/`web_fetch`, `WebSearch`/`WebFetch`, an MCP tool â€” use those.

This skill covers 6 scenarios: 3 content types (video, podcast, short-form) Ã— 2 states (new or underperforming). Each has its own mode below.
...
The sections below are organized as: **Steps â†’ Rules â†’ Templates â†’ Checks**. Follow them in order:

1. **Read the user's request** â€” scope check first (see below)
2. **Steps 0-2** â€” Classify, find the keyword, research it, gather missing info
...
## Step 0 â€” Check scope then classify

**Scope check first.** This skill handles one video, podcast episode, or short-form clip at a time â€” not entire channels or playlists. If the user asks for something outside that, say: *"I can optimize individual videos or episodes. Which one should I start with?"* Once they pick one, restart the flow from Step 0 with that specific item.

**Then classify.** Read the user's message first â€” they might have already told you everything. Don't ask something they just said.

**Content type** â€” If unclear from what they said, ask once: *"Is this a regular video, a podcast episode, or a Short/Reel?"*

**Status** â€” Did they give a URL? Fetch it. Did they say "no views" or "not ranking"? It's existing. Did they say "uploading" or "about to post"? It's new. If you can't tell, ask once.
...
If they gave a URL, fetch the live metadata â€” don't ask them to repeat what's already there.

---

## Step 1 â€” Find the target keyword
...
If the user asked for just a title or just tags, skip the full research batch â€” but still do one quick search to validate the keyword angle. Otherwise run the full research:
- `[target keyword]` â€” see what's ranking
- `[target keyword] [current year]`
- `[niche/topic] trending` or `[target keyword] reddit` â€” real phrasing people use
- For podcasts: also search the guest's name

Pull 3-6 related phrases as secondary/long-tail keywords.

**No data you don't have:** never make up search volume, view counts, or algorithm claims. A thin result set is fine â€” lower competition.

**Use today's real date** for every "[Year]" slot.

**Verify superlatives.** If they say "top 10," "#1," "fastest-growing" â€” search for proof. If unverified, drop it or mark `[VERIFY: ...]`.

---

## Step 2 â€” Gather what you still need (scrape first, ask last)
...
One question at a time. After each answer, see if you can fill the rest from what you learned. If they say "placeholders," use `[ADD: ...]` markers â€” never fake URLs.
...
### Power word bank
How Â· Why Â· What Â· Best Â· Full Â· Real Â· Free Â· New Â· Step-by-Step Â· Complete Â· Proven Â· Ultimate Â· Inside Â· Secret Â· Zero to Â· In [X] Days Â· [Number] Ways Â· [Year]

### Rules
- 60-70 characters exactly â€” count them
...
- First 3 hashtags surface below the title â€” choose strategically
- Placement: final line of the description only â€” never in the tags field
- Format: CamelCase (`#AgritechNepal`)
- Mix: 2 broad + 2 specific + 1-2 geo + 1 branded
- Don't reuse an identical set across every upload â€” vary 3-6 per video
...
### Block 1 â€” Hook (first ~150 characters, shown in search results)
...
### Block 2 â€” Body
- 4-6 short paragraphs or â–¶-marked list
- Weave in secondary keywords â€” one per paragraph, naturally
...
### Block 3 â€” Footer
- ðŸ”— Resources & Links with real links from Step 2
...
```
[Hook â€” target keyword in sentence 1. Core promise. Who this is for.]
...
[Body paragraph â€” secondary keyword woven in naturally]

[Body paragraph â€” secondary keyword woven in naturally]

[Body paragraph â€” geo signal if applicable]

[Body paragraph â€” guest bio (podcast) or credentials (video)]

Use the chapters below to jump to any section â†“

ðŸ“Œ CHAPTERS / TOPICS DISCUSSED
0:00 â€“ [Chapter/topic]
[N:NN] â€“ [Continue]

==========================
ðŸ”— RESOURCES & LINKS
ðŸŒ Website: [real link from Step 2]
ðŸ’¼ LinkedIn: [real link from Step 2]
ðŸ“º Subscribe: [real link from Step 2]
ðŸ“§ Contact: [real link from Step 2]
[Podcast â€” ðŸŽ§ Listen on: Spotify | Apple Podcasts | ...]

[Subscribe CTA â€” 2 sentences, includes channel/show name]
...
- First chapter MUST be `0:00` â€” YouTube ignores all chapters without it
...
If they ask for a Short without mentioning a source video, ask: *"Which video should I pull the Short from?"* â€” once they tell you, treat the Short as the primary request and use Mode E directly (no need to also package the source video).
...
- **Description:** 150-200 words â€” hook + hashtags, no chapters
...
## Mode A â€” New Video Upload Package
...
â‘¦ CHAPTERS / TIMESTAMPS (6-10 markers)
0:00 â€“ [Chapter title]
[N:NN] â€“ [Chapter title]
...
â‘« END SCREEN SCRIPT
"[2-3 sentences â€” natural speech, next topic + subscribe]"
...
## Mode B â€” Existing Video Audit + Fix

### Required input
- YouTube URL (preferred â€” fetch live metadata) or current title/description
- Views/performance complaint

### Output template
```
==================================================
ðŸ” YOUTUBE SEO AUDIT REPORT
==================================================
...
==================================================
SECTION 1 â€” AUDIT SCORECARD
==================================================

| Element            | Score     | Issue Found |
|--------------------|-----------|-------------|
| Title              | âœ…/âš ï¸/âŒ  | [Finding]   |
| Description        | âœ…/âš ï¸/âŒ  | [Finding]   |
| Tags               | âœ…/âš ï¸/âŒ  | [Finding]   |
| Hashtags           | âœ…/âš ï¸/âŒ  | [Finding]   |
| Chapters           | âœ…/âš ï¸/âŒ  | [Finding]   |
| Keyword targeting  | âœ…/âš ï¸/âŒ  | [Finding]   |
| Geo/Local SEO      | âœ…/âš ï¸/âŒ  | [Finding]   |
| Thumbnail text     | âœ…/âš ï¸/âŒ  | [Finding]   |
| Cards/End screen   | âœ…/âš ï¸/âŒ  | [Finding]   |
| Pinned comment     | âœ…/âš ï¸/âŒ  | [Finding]   |

OVERALL SEO SCORE: [X/10]
PRIORITY FIXES: [Top 3 issues]

==================================================
SECTION 2 â€” DETAILED FINDINGS
==================================================
...
==================================================
SECTION 3 â€” FULL REWRITTEN METADATA
==================================================

â‘  REWRITTEN TITLE (Primary)
[New title â€” 60-70 chars]
Character count: [N]/70

â‘¡ REWRITTEN TITLE (A/B Variant)
[Alternative title â€” different hook]
Character count: [N]/70

â‘¢ REWRITTEN DESCRIPTION
[Full 3-block description]

â‘£ REWRITTEN TAGS
[14-19 tags across all 7 types]

â‘¤ REWRITTEN HASHTAGS
#Tag1 #Tag2 #Tag3 #Tag4 #Tag5 [#Tag6 #Tag7 optional]

â‘¥ REWRITTEN CHAPTERS (6-10 markers)
0:00 â€“ [Chapter]
[N:NN] â€“ [Continue]
...
â‘§ PINNED COMMENT (replace existing)
[Target keyword + value teaser]

==================================================
SECTION 4 â€” POST-FIX ACTION PLAN
==================================================

Step 1 â€” Do immediately (YouTube Studio):
  â–¡ Replace title
  â–¡ Replace description
  â–¡ Replace tags
  â–¡ Add chapters if missing
  â–¡ Post new pinned comment

Step 2 â€” Within 48 hours:
  â–¡ Update thumbnail if flagged
  â–¡ Add to correct playlist
  â–¡ Share updated link

Step 3 â€” Check in 7 days:
  â–¡ Monitor CTR in Analytics
  â–¡ If impressions up but CTR flat, fix thumbnail
  â–¡ Try A/B title after 14 days if no improvement
...
## Mode C â€” New Podcast Episode Package
...
```
==================================================
ðŸŽ™ï¸ PODCAST EPISODE SEO PACKAGE â€” NEW EPISODE
==================================================

â‘  SEO TITLE (Primary)
[Title â€” 60-70 chars. Lead with guest name if searchable, else keyword.]
Character count: [N]/70
...
â‘¢ DESCRIPTION
[Full description â€” guest bio in Block 2, platform links in Block 3]
...
â‘¤ TAGS
[tag1], [tag2] ... [tag14-19 â€” include show + guest name]
Total: [N]/500

â‘¥ HASHTAGS
#Tag1 #Tag2 #Tag3 #Tag4 #Tag5 [#Tag6 #Tag7 optional]

â‘¦ TOPICS DISCUSSED (6-10 markers)
0:00 â€“ Intro
[N:NN] â€“ Guest intro
[N:NN] â€“ [Topic 1]
[N:NN] â€“ Sponsor read (if applicable)
[N:NN] â€“ [Topic 2]
[N:NN] â€“ Closing / where to find guest
...
â‘« LISTEN ON
ðŸŽ§ Spotify: [link]
ðŸŽ§ Apple Podcasts: [link]
ðŸŽ§ [Other platforms as supplied]

â‘¬ END SCREEN SCRIPT
"[2-3 sentences â€” thank guest, tease next, subscribe]"
...
## Mode D â€” Existing Podcast Episode Audit + Fix
...
```
==================================================
ðŸ” PODCAST EPISODE SEO AUDIT REPORT
==================================================
...
| Tags                 | âœ…/âš ï¸/âŒ  | [Finding]   |
| Hashtags             | âœ…/âš ï¸/âŒ  | [Finding]   |
| Topics/Timestamps    | âœ…/âš ï¸/âŒ  | [Finding]   |
| Keyword targeting    | âœ…/âš ï¸/âŒ  | [Finding]   |
| Guest bio + links    | âœ…/âš ï¸/âŒ  | [Finding]   |
| Platform links       | âœ…/âš ï¸/âŒ  | [Finding]   |
| Sponsor disclosure   | âœ…/âš ï¸/âŒ  | [Finding]   |
| Series/playlist      | âœ…/âš ï¸/âŒ  | [Finding]   |
| Pinned comment       | âœ…/âš ï¸/âŒ  | [Finding]   |
...
â‘¥ REWRITTEN TOPICS / TIMESTAMPS (6-10)
0:00 â€“ Intro
[N:NN] â€“ [Continue]
...
Step 1 â€” Do immediately (YouTube Studio):
  ...
  â–¡ Replace description
  â–¡ Replace tags
  â–¡ Add/fix timestamps
  â–¡ Post new pinned comment

Step 2 â€” Within 48 hours:
  â–¡ Update thumbnail if flagged
  â–¡ Add to correct playlist
  â–¡ Cross-post platform links
  â–¡ Share with guest

Step 3 â€” Check in 7 days:
  â–¡ Monitor CTR
  â–¡ Try A/B title after 14 days if flat
...
## Mode E â€” New Short-Form / Reel Package
...
```
==================================================
ðŸŽ¬ SHORT-FORM SEO PACKAGE â€” NEW SHORT / REEL / CLIP
==================================================

â‘  YOUTUBE SHORTS TITLE (Primary)
[Title â€” 60-70 chars. Keyword in first 3 words. One power word/hook.]
Character count: [N]/70
...
â‘¥ HASHTAGS (3-5, #Shorts always included)
#Shorts #Tag2 #Tag3 [#Tag4 #Tag5 optional]

â‘¦ CROSS-POST CAPTION (Reels / TikTok â€” if cross-posting)
[60-150 words. Keyword in first ~125 chars. End with 3-5 hashtags.]

â‘§ COVER FRAME / THUMBNAIL TEXT
"[3-5 bold words]"
...
â‘© END-OF-CLIP CTA
[1 sentence â€” "full episode linked above", "part 2 tomorrow", etc.]
...
## Mode F â€” Existing Short-Form Audit + Fix
...
```
==================================================
ðŸ” SHORT-FORM SEO AUDIT REPORT
==================================================
...
|---------------------|-----------|-------------|
| Title               | âœ…/âš ï¸/âŒ  | [Finding]   |
| Description/Caption | âœ…/âš ï¸/âŒ  | [Finding]   |
| Hashtags            | âœ…/âš ï¸/âŒ  | [Finding]   |
| Keyword targeting   | âœ…/âš ï¸/âŒ  | [Finding]   |
| Cover/thumbnail text| âœ…/âš ï¸/âŒ  | [Finding]   |
...
==================================================
SECTION 3 â€” REWRITTEN METADATA
==================================================
...
â‘¢ REWRITTEN DESCRIPTION (150-200 words)
[Keyword in sentence 1, hashtags on final line]

â‘£ REWRITTEN TAGS (5-8)
[tags]

â‘¤ REWRITTEN HASHTAGS (3-5, #Shorts included)
#Shorts #Tag2 #Tag3

â‘¥ CROSS-POST CAPTION (if applicable)
[60-150 words, keyword in first 125 chars]

â‘¦ COVER/THUMBNAIL TEXT
"[3-5 word overlay]"
...
Step 1 â€” Do immediately:
  â–¡ Replace title, description, hashtags, tags
  â–¡ Move hashtags out of title into description if needed
  â–¡ Update cover frame if flagged

Step 2 â€” Check in 7 days:
  â–¡ Monitor retention/completion rate
  â–¡ If impressions up but completion flat, fix hook first
...
- **Only say what they need** â€” don't dump sections they didn't request

Reference the rules by section:
1. **Title** â†’ Title Rules
2. **Description** â†’ Description Structure
3. **Tags** â†’ Tags Strategy
4. **Hashtags** â†’ Hashtag Rules
5. **Chapters** â†’ Chapters / Timestamps Rules
6. **Geo/Local** â†’ Geo / Local SEO Rules

Then run the Quality Checklist below.

---

## Quality Checklist â€” run before sending
...
- [ ] Step 1 search batch run â€” secondary keywords from real results
...
**Video, new upload:** User says "uploading a video about how farmers in Nepal can use mobile apps to sell vegetables directly." â†’ Confirm target keyword ("sell vegetables online Nepal"), run Step 1, produce Mode A package â€” title, A/B variant, 800-word description with geo signals, 18 tags, 7 hashtags, 8 chapters, thumbnail text, cards, playlist note, pinned comment, end-screen script.

**Podcast, existing episode, underperforming:** User says "My episode with [guest] has barely any views, here's the URL." â†’ Fetch URL, confirm target keyword, produce Mode D audit â€” scorecard, detailed findings, rewritten metadata, action plan.

**Short-form, new clip from a podcast:** User says "Cut a Short from the Antigravity Awesome Skills part of that episode." â†’ Mode E: reuse episode's keyword and tags, 60-70 char title, 150-200 word description, 3-5 hashtags including `#Shorts`, cross-post caption.
