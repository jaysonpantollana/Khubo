---
name: voice-agents
description: "Use when working with voice-agents"
---
...
lowest latency, most natural) and pipeline (STTâ†’LLMâ†’TTS, more control,
...
- phone-system-integration â†’ backend
- audio-processing-dsp â†’ audio-specialist
- music-generation â†’ audio-specialist
- accessibility-compliance â†’ accessibility-specialist
...
"""
[User Audio] â†’ [S2S Model] â†’ [Agent Audio]
...
"""
[Audio] â†’ [STT] â†’ [Text] â†’ [LLM] â†’ [Text] â†’ [TTS] â†’ [Audio]
