...
description: "Use when working with tao-train-oneformer"
---
...
- **train.num_epochs**: Default 50 â€” significantly higher than most TAO models. OneFormer needs more epochs for convergence.
...
- [tao-deploy-oneformer](references/tao-deploy-oneformer.md) â€” OneFormer deploy workflow for TensorRT engine generation, TensorRT evaluation, and TensorRT inference using TAO Deploy.
