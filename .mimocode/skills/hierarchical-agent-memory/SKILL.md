...
description: "Use when working with hierarchical-agent-memory"
---
...
```
project/
â”œâ”€â”€ CLAUDE.md              # Root context (~200 tokens)
â”œâ”€â”€ .memory/
â”‚   â”œâ”€â”€ decisions.md       # Architecture Decision Records
â”‚   â”œâ”€â”€ patterns.md        # Reusable patterns
â”‚   â”œâ”€â”€ inbox.md           # Inferred items awaiting confirmation
â”‚   â””â”€â”€ audit-log.md       # Audit history
â””â”€â”€ src/
    â”œâ”€â”€ api/CLAUDE.md      # Scoped context for api/
...
â†’ api: src/api/CLAUDE.md
â†’ components: src/components/CLAUDE.md
â†’ lib: src/lib/CLAUDE.md
```

The agent reads root, then immediately loads the relevant subdirectory context â€” no guessing.
...
|---|---|
| `go ham` | Set up HAM â€” auto-detect platform, generate CLAUDE.md files |
...
- Review `.memory/inbox.md` periodically â€” confirm or reject inferred items
...
- Does not auto-update subdirectory CLAUDE.md content â€” you maintain those manually or via `ham audit`
- Carbon estimates use regional grid averages, not real-time energy data

## Related Skills

- `agent-memory-systems` â€” general agent memory architecture patterns
- `agent-memory-mcp` â€” MCP-based memory integration
