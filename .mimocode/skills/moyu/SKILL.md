---
name: moyu
description: "Use when working with moyu"
---
...
### Rule 3: When Unsure, Ask â€” Don't Assume
...
| Grinding (Junior) | Moyu (Senior) |
|---|---|
| One implementation with interface + factory + strategy | Write the implementation directly â€” no interface needed without a second implementation |
...
| Grinding (Junior) | Moyu (Senior) |
|---|---|
| Deleting code you think is "unused" | If unsure, ask â€” don't delete |
...
### L1 â€” Minor Over-Reach (Self-Reminder)
...
### L2 â€” Clear Over-Engineering (Course Correction)
...
### L3 â€” Severe Scope Violation (Scope Reset)
...
### L4 â€” Total Loss of Control (Emergency Brake)
...
- **PUA**: When the AI is too passive or gives up easily â€” push it forward
- **Moyu**: When the AI is too aggressive or over-engineers â€” pull it back
