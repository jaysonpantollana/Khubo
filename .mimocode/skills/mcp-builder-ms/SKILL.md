---
name: mcp-builder-ms
description: "Use when working with mcp-builder-ms"
---
...
**Full ecosystem:** See ðŸ”· Microsoft MCP Patterns for complete server catalog and patterns.
...
- **MCP Best Practices**: ðŸ“‹ View Best Practices - Core guidelines

**For TypeScript (recommended):**
- **TypeScript SDK**: Use WebFetch to load `https://raw.githubusercontent.com/modelcontextprotocol/typescript-sdk/main/README.md`
- âš¡ TypeScript Guide - TypeScript patterns and examples

**For Python:**
- **Python SDK**: Use WebFetch to load `https://raw.githubusercontent.com/modelcontextprotocol/python-sdk/main/README.md`
- ðŸ Python Guide - Python patterns and examples

**For C#/.NET (Microsoft ecosystem):**
- ðŸ”· Microsoft MCP Patterns - C# patterns, Azure MCP architecture, command hierarchy
...
- âš¡ TypeScript Guide - Project structure, package.json, tsconfig.json
- ðŸ Python Guide - Module organization, dependencies
- ðŸ”· Microsoft MCP Patterns - C# project structure, command hierarchy
...
**Load âœ… Evaluation Guide for complete evaluation guidelines.**
...
- ðŸ“‹ MCP Best Practices - Universal MCP guidelines including:
...
- ðŸ”· Microsoft MCP Patterns - Microsoft-specific patterns including:
...
- ðŸ Python Implementation Guide - Complete Python/FastMCP guide with:
...
- âš¡ TypeScript Implementation Guide - Complete TypeScript guide with:
  - Project structure
  - Zod schema patterns
...
- ðŸ”· Microsoft MCP Patterns - Complete C#/.NET guide with:
  - Command hierarchy (BaseCommand â†’ GlobalCommand â†’ SubscriptionCommand)
...
- âœ… Evaluation Guide - Complete evaluation creation guide with:
