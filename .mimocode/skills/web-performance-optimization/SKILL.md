...
description: "Use when working with web-performance-optimization"
---
...
- **LCP (Largest Contentful Paint):** 4.2s âŒ (should be < 2.5s)
- **FID (First Input Delay):** 180ms âŒ (should be < 100ms)
- **CLS (Cumulative Layout Shift):** 0.25 âŒ (should be < 0.1)
...
- **LCP:** 1.8s âœ… (improved by 57%)
- **FID:** 45ms âœ… (improved by 75%)
- **CLS:** 0.05 âœ… (improved by 80%)
...
- **Total Bundle:** 380KB âœ… (reduced by 55%)
- **Main Bundle:** 180KB âœ…
- **Vendor Bundle:** 80KB âœ…
- **Load Time (3G):** 3.1s âœ… (improved by 62%)
```
