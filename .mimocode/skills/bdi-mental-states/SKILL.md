...
description: "Use when working with bdi-mental-states"
---
...
9. Define existential restrictions on mental processes (e.g., `BeliefProcess âŠ‘ âˆƒgenerates.Belief`).
