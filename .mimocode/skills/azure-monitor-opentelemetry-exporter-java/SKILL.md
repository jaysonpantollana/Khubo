...
description: "Use when working with azure-monitor-opentelemetry-exporter-java"
---
...
> **âš ï¸ DEPRECATION NOTICE**: This package is deprecated. Migrate to `azure-monitor-opentelemetry-autoconfigure`.
>
...
1. **Use autoconfigure** â€” Migrate to `azure-monitor-opentelemetry-autoconfigure`
2. **Set meaningful span names** â€” Use descriptive operation names
3. **Add relevant attributes** â€” Include contextual data for debugging
4. **Handle exceptions** â€” Always record exceptions on spans
5. **Use semantic conventions** â€” Follow OpenTelemetry semantic conventions
6. **End spans in finally** â€” Ensure spans are always ended
7. **Use try-with-resources** â€” Scope management with try-with-resources pattern
