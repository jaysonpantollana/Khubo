...
description: "Use when working with nemoclaw-user-deploy-remote"
---
...
- `nemoclaw-user-manage-sandboxes` â€” Set Up Messaging Channels (use the `nemoclaw-user-manage-sandboxes` skill) to connect Telegram, Discord, or Slack through OpenShell-managed channel messaging
- `nemoclaw-user-monitor-sandbox` â€” Monitor Sandbox Activity (use the `nemoclaw-user-monitor-sandbox` skill) for sandbox monitoring tools
- `nemoclaw-user-reference` â€” Commands (use the `nemoclaw-user-reference` skill) for the full `deploy` command reference
