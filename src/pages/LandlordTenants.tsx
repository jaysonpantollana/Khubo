...
import { ArrowLeft, ChevronLeft, ChevronRight, Copy, Phone, Plus, Check } from 'lucide-react';
              ...
              <tbody>
                {filteredTenants.length > 0 ? (
                  filteredTenants.map((tenant, index) => (
                    <tr 
                      key={tenant.id} 
                      className={`${index !== filteredTenants.length - 1 ? 'border-b border-neutral-50' : ''} g-neutral-50/50 transition-colors`}
                    >
                      ...
                      <td className="p-4 text-neutral-500 font-medium whitespace-nowrap">
                        <button
                          ...
                          className={`px-2 py-1 rounded text-xs font-bold cursor-pointer transition-colors ${
                            tenant.balance === 'Paid' ? 'bg-green-100 text-green-700 g-green-200' : 'bg-red-100 text-red-700 g-red-200'
                          }`}
                        >
                          {tenant.balance}
                        </button>
                      ...
                      <td className="p-4 whitespace-nowrap text-neutral-500 font-medium">
                        <span className="flex items-center gap-1.5">
                          ...
                          <button
                            ...
                            className="p-1 g-neutral-100 rounded transition-colors text-neutral-400 ext-neutral-600"
                          >
                      ...
                      <td className="p-4 whitespace-nowrap font-medium">
                        <div className="flex items-center gap-3">
                          <a href={tenant.social.instagram} target="_blank" rel="noopener noreferrer" className="text-neutral-400 ext-pink-500 transition-colors">
                          ...
                          <a href={tenant.social.x} target="_blank" rel="noopener noreferrer" className="text-neutral-400 ext-black transition-colors">
                            <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                          </a>
                          <a href={tenant.social.facebook} target="_blank" rel="noopener noreferrer" className="text-neutral-400 ext-blue-600 transition-colors">
