...
export const CATEGORIES: Category[] = [
  ...
  { label: 'Dormitory', icon: 'School', emoji: '' },
  { label: 'Room 4 rent', icon: 'DoorOpen', emoji: '' },
  { label: 'Condominium', icon: 'Building2', emoji: '' },
  { label: 'All males', icon: 'UserCircle2', emoji: '' },
  { label: 'Shared', icon: 'Users', emoji: '' },
  { label: 'All females', icon: 'UserCircle', emoji: '' },
  { label: 'No pets allowed', icon: 'Ban', emoji: '' },
  { label: 'Quite hours', icon: 'Moon', emoji: '' },
  { label: 'Free water', icon: 'Droplet', emoji: '' },
  { label: 'Free electricity', icon: 'Zap', emoji: '' },
  { label: 'No curfew', icon: 'Clock', emoji: '' },
  { label: 'Gated', icon: 'Lock', emoji: '' },
  { label: 'Study area', icon: 'BookOpen', emoji: '' },
