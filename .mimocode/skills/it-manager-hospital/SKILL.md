...
description: "Use when working with it-manager-hospital"
---
...
1.  **The Clinical Strategist (HIMSS/ONA):** Focada em maturidade digital e seguranÃ§a assistencial.
...
- **ONA (Brasil):** Requirements for NÃ­vel 1 (Safety), 2 (Management), and 3 (Excellence).
...
- **Interoperability:** Managing internal and external integrations via HL7/FHIR and RNDS (Rede Nacional de Dados em SaÃºde).
