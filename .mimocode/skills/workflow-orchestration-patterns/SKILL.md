...
description: "Use when working with workflow-orchestration-patterns"
---
...
- âŒ Threading, locks, synchronization primitives
- âŒ Random number generation (`random()`)
- âŒ Global state or static variables
- âŒ System time (`datetime.now()`)
- âŒ Direct file I/O or network calls
- âŒ Non-deterministic libraries
