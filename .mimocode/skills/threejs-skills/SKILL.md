---
name: threejs-skills
description: "Use when working with threejs-skills"
---
...
- âŒ Using `outputEncoding` instead of `outputColorSpace` (renamed in r152)
- âŒ Forgetting to add objects to scene with `scene.add()`
- âŒ Using lit materials without adding lights
- âŒ Not handling window resize
- âŒ Forgetting to call `renderer.render()` in animation loop
- âŒ Using `THREE.Clock` without considering `THREE.Timer` (recommended in r183)
...
8. **Result**: Smooth, interactive 3D sphere âœ“
...
â”œâ”€â”€ React Three Fiber (optional - React integration)
â”œâ”€â”€ Drei (helper components)
â”œâ”€â”€ Leva (debug GUI)
â””â”€â”€ Post-processing effects
```
