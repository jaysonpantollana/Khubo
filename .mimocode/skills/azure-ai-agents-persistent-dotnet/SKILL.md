...
description: "Use when working with azure-ai-agents-persistent-dotnet"
---
...
â”œâ”€â”€ Administration  â†’ Agent CRUD operations
â”œâ”€â”€ Threads         â†’ Thread management
â”œâ”€â”€ Messages        â†’ Message operations
â”œâ”€â”€ Runs            â†’ Run execution and streaming
â”œâ”€â”€ Files           â†’ File upload/download
â””â”€â”€ VectorStores    â†’ Vector store management
```
...
1. **Always dispose clients** â€” Use `using` statements or explicit disposal
2. **Poll with appropriate delays** â€” 500ms recommended between status checks
3. **Clean up resources** â€” Delete threads and agents when done
4. **Handle all run statuses** â€” Check for `RequiresAction`, `Failed`, `Cancelled`
5. **Use streaming for real-time UX** â€” Better user experience than polling
6. **Store IDs not objects** â€” Reference agents/threads by ID
7. **Use async methods** â€” All operations should be async
