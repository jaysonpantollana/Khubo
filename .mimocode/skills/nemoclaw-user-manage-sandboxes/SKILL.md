...
description: "Use when working with nemoclaw-user-manage-sandboxes"
---
...
- **[references/runtime-controls.md](references/runtime-controls.md)** â€” Single page that answers what can change at runtime versus what requires a rebuild for NemoClaw sandboxes.
...
- `nemoclaw-user-monitor-sandbox` â€” Monitor Sandbox Activity (use the `nemoclaw-user-monitor-sandbox` skill) for observability tools
