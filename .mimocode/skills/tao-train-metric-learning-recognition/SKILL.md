...
description: "Use when working with tao-train-metric-learning-recognition"
---
...
- No explicit `num_nodes` or `distributed_strategy` config â€” single-node oriented
...
- [tao-deploy-metric-learning-recognition](references/tao-deploy-metric-learning-recognition.md) â€” MLRecog deploy workflow for TensorRT engine generation, TensorRT evaluation, and TensorRT inference using TAO Deploy.
