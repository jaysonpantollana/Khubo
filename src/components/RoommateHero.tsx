...
import { Search, MapPin, Megaphone, ChevronDown, ChevronUp, Wallet, X } from 'lucide-react';
    ...
    <div className="relative min-h-[400px] md:h-[500px] w-full z-50">
      ...
      <div className="relative z-10 max-w-[2520px] mx-auto h-full px-4 md:px-12">
        ...
        <div className="flex flex-col items-center justify-center text-center h-full pt-10 md:pt-10">
          ...
          >
            <h1 className="font-noto-serif italic text-white text-base sm:text-xl md:text-[35px] tracking-tight leading-tight">
          ...
          >
            ...
            {/* Pill search bar */}
            <div className="bg-white/10 backdrop-blur-md border border-white/20 p-[3px] sm:p-1.5 md:p-2 rounded-full flex items-center text-white shadow-2xl w-[calc(100vw-1.5rem)] max-w-[820px] relative z-[95] pointer-events-auto cursor-default">
            {isSearchActive ? (
              <>
              ...
              <>
                <div className="flex-1 min-w-0">
                  ...
                  >
                    ...
                    <ChevronDown className={`flex-shrink-0 opacity-50 transition-opacity w-3 h-3 md:w-4 md:h-4 ml-1 ${activeDropdown === 'location' ? 'rotate-180 text-neutral-900' : ''}`} />
                  </div>
                ...
                <div className="flex-1 min-w-0">
                  ...
                  >
                    ...
                    <ChevronDown className={`flex-shrink-0 opacity-50 transition-opacity w-3 h-3 md:w-4 md:h-4 ml-1 ${activeDropdown === 'budget' ? 'rotate-180 text-neutral-900' : ''}`} />
                  </div>
