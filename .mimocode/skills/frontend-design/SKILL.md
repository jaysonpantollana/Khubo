...
description: "Use when working with frontend-design"
---
...
* Avoid generic â€œAI UIâ€ patterns
...
2. **Technical Correctness**
   Real, working HTML/CSS/JS or framework code â€” not mockups.
...
âŒ No default layouts
âŒ No design-by-components
âŒ No â€œsafeâ€ palettes or fonts
âœ… Strong opinions, well executed
...
```
DFII = (Impact + Fit + Feasibility + Performance) âˆ’ Consistency Risk
```
...
| DFII      | Meaning   | Action                      |
| --------- | --------- | --------------------------- |
| **12â€“15** | Excellent | Execute fully               |
| **8â€“11**  | Strong    | Proceed with discipline     |
| **4â€“7**   | Risky     | Reduce scope or effects     |
...
âš ï¸ Do not blend more than **two**.

### 3. Differentiation Anchor

Answer:

> â€œIf this were screenshotted with the logo removed, how would someone recognize it?â€
...
* Full working code
* Comments only where intent isnâ€™t obvious

### 4. Differentiation Callout

Explicitly state:

> â€œThis avoids generic UI by doing X instead of Y.â€

---

## 7. Anti-Patterns (Immediate Failure)

âŒ Inter/Roboto/system fonts
âŒ Purple-on-white SaaS gradients
âŒ Default Tailwind/ShadCN layouts
âŒ Symmetrical, predictable sections
âŒ Overused AI design tropes
âŒ Decoration without intent
