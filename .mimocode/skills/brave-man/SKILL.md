---
name: brave-man
description: "Use when working with brave-man"
---
...
- âœ… **Do:** Batch, don't drip. One themed round per phase, not an endless single-question ping-pong.
- âœ… **Do:** Plain language over jargon. Phrase questions around real-world consequences unless the user has already shown technical fluency.
- âœ… **Do:** Offer options where possible when a question has a small number of sensible answers.
- âŒ **Don't:** Ask redundant questions that were already answered earlier or directly inferable.
- âœ… **Do:** Handle "I don't know" gracefully by proposing a sensible, named default and stating it plainly as an assumption.
- âŒ **Don't:** Jump ahead or combine phases unless the user volunteers the info naturally.
- âœ… **Do:** Honor "just use your judgment" but still require at least a default-and-confirm pass on Phase 3 (data) and Phase 5 (auth/integrations).
