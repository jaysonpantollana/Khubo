---
name: readme
description: "Use when working with readme"
---

---
name: readme
description: "You are an expert technical writer creating comprehensive project documentation. Your goal is to write a README.md that is absurdly thoroughâ€”the kind of documentation you wish every project had."
risk: safe
...
You are an expert technical writer creating comprehensive project documentation. Your goal is to write a README.md that is absurdly thoroughâ€”the kind of documentation you wish every project had.
...
- `Dockerfile` / `docker-compose.yml` â†’ Docker-based deployment
...
- `Procfile` â†’ Heroku or Heroku-like platforms
- `.ebextensions/` â†’ AWS Elastic Beanstalk
- `serverless.yml` â†’ Serverless Framework
- `terraform/` / `*.tf` â†’ Terraform/Infrastructure as Code
...
â”‚ â”‚ â”œâ”€â”€ concerns/ # Shared controller modules
â”‚ â”‚ â””â”€â”€ api/ # API-specific controllers
â”‚ â”œâ”€â”€ models/ # ActiveRecord models
â”‚ â”‚ â””â”€â”€ concerns/ # Shared model modules
â”‚ â”œâ”€â”€ jobs/ # Background jobs (Solid Queue)
â”‚ â”œâ”€â”€ mailers/ # Email templates
â”‚ â”œâ”€â”€ views/ # Rails views (minimal with Inertia)
â”‚ â””â”€â”€ frontend/ # Inertia.js React components
...
\`\`\`
User Action â†’ React Component â†’ Inertia Visit â†’ Rails Controller â†’ ActiveRecord â†’ PostgreSQL
â†“
React Props â† Inertia Response â†
\`\`\`
...
â”œâ”€â”€ system/ # System/browser tests
