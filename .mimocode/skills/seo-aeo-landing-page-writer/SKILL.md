...
description: "Use when working with seo-aeo-landing-page-writer"
---
...
Write one 25â€“40 word sentence that answers "What is [product]?" â€” standalone, no jargon, placed in a blockquote immediately after the H1. This is the sentence AI engines extract.

### Step 3: Follow the Narrative Arc
Write sections in this exact order:
1. Hero â€” H1 + AEO sentence + CTA
2. Problem â€” audience pain, no product mention yet
3. Solution â€” introduce product as the answer
4. Features as Benefits â€” table format
5. Social Proof â€” testimonials, logos, stats
6. Mid-page CTA
7. How It Works â€” numbered steps
8. Comparison â€” table with honest competitor comparison
9. FAQ â€” minimum 6 entries, each under 50 words
10. Trust Signals
11. Final CTA
...
"4,000+ remote teams" Â· "40% fewer status meetings" Â· "4.8/5 on G2"
...
users. A 14-day free trial is available â€” no credit card required.

## Best Practices

- âœ… **Do:** Write the problem section before mentioning the product â€” empathy first
- âœ… **Do:** Place the AEO extraction sentence in a blockquote immediately after H1
- âœ… **Do:** Write FAQ answers as standalone â€” each must make sense without context
- âœ… **Do:** Include at least one honest point in the comparison table where the alternative wins
- âŒ **Don't:** Use "revolutionary", "game-changing", or "best-in-class" anywhere
- âŒ **Don't:** Use "Submit" or "Click Here" as CTA button text
- âŒ **Don't:** Write paragraphs longer than 4 lines
...
- `@seo-aeo-keyword-research` â€” provides the primary keyword and AEO queries
- `@seo-aeo-meta-description-generator` â€” writes title and meta description from page output
- `@seo-aeo-content-quality-auditor` â€” audits the completed landing page
