...
description: "Use when working with frontend-dev-guidelines"
---
...
âŒ `isLoading`
âŒ manual spinners
âŒ fetch logic inside components
âŒ API calls without feature API layer
...
âŒ Never return early loaders
...
âŒ Early loading returns
âŒ Feature logic in `components/`
âŒ Shared state via prop drilling instead of hooks
âŒ Inline API calls
âŒ Untyped responses
âŒ Multiple responsibilities in one component
