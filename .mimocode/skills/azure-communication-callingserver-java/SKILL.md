...
description: "Use when working with azure-communication-callingserver-java"
---

---
name: azure-communication-callingserver-java
description: "âš ï¸ DEPRECATED: This SDK has been renamed to Call Automation. For new projects, use azure-communication-callautomation instead. This skill is for maintaining legacy code only."
risk: safe
source: community
...
> **âš ï¸ DEPRECATED**: This SDK has been renamed to **Call Automation**. For new projects, use `azure-communication-callautomation` instead. This skill is for maintaining legacy code only.
