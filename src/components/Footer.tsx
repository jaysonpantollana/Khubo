        ...
        <div className="mx-auto w-fit grid grid-cols-1 md:grid-cols-4 gap-0 md:gap-40 mt-2 lg:mt-0 border-t border-neutral-200 md:border-t-0">
          ...
          <div className="flex flex-col md:gap-6 border-b border-neutral-200 md:border-b-0">
            ...
            <div className={`flex-col gap-4 text-sm text-neutral-600 font-medium pb-4 md:pb-0 ${openSection === 'support' ? 'flex' : 'hidden md:flex'}`}>
              <a href="#" className="ext-[#17294F] transition">Help Center</a>
              <a href="#" className="ext-[#17294F] transition">Contact Us</a>
              <a href="https://forms.gle/QLdAfaUjVyNFoKSr6" target="_blank" rel="noopener noreferrer" className="ext-[#17294F] transition">Report an Issue</a>
            </div>
          </div>
          ...
          <div className="flex flex-col md:gap-6 border-b border-neutral-200 md:border-b-0">
            ...
            <div className={`flex-col gap-4 text-sm text-neutral-600 font-medium pb-4 md:pb-0 ${openSection === 'community' ? 'flex' : 'hidden md:flex'}`}>
              <a href="#" className="ext-[#17294F] transition">Reviews</a>
              <a href="#" className="ext-[#17294F] transition">Stories</a>
              <a href="https://forms.gle/khaEHq6xsEfWnKeq8" target="_blank" rel="noopener noreferrer" className="ext-[#17294F] transition">Suggest a Feature</a>
            </div>
          </div>
          ...
          <div className="flex flex-col md:gap-6 border-b border-neutral-200 md:border-b-0">
            ...
            <div className={`flex-col gap-4 text-sm text-neutral-600 font-medium pb-4 md:pb-0 ${openSection === 'hosting' ? 'flex' : 'hidden md:flex'}`}>
              <a href="#" className="ext-[#17294F] transition">List Your Property</a>
              <a href="#" className="ext-[#17294F] transition">Host Resources</a>
              <a href="#" className="ext-[#17294F] transition">Community Forum</a>
              <a href="#" className="ext-[#17294F] transition">Hosting Tips</a>
            </div>
          </div>
          ...
          <div className="flex flex-col md:gap-6 border-b border-neutral-200 md:border-b-0">
            ...
            <div className={`flex-col gap-4 text-sm text-neutral-600 font-medium pb-4 md:pb-0 ${openSection === 'legal' ? 'flex' : 'hidden md:flex'}`}>
              <Link to="/privacy" className="ext-[#17294F] transition">Privacy Policy</Link>
            </div>
          </div>
