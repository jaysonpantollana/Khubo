...
description: "Use when working with claude-in-chrome-troubleshooting"
---
...
1. Both register native messaging configs in Chrome:
   - `com.anthropic.claude_browser_extension.json` â†’ Claude.app helper
   - `com.anthropic.claude_code_browser_extension.json` â†’ Claude Code wrapper
