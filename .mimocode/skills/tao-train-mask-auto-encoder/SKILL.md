...
description: "Use when working with tao-train-mask-auto-encoder"
---
...
- [tao-deploy-mask-auto-encoder](references/tao-deploy-mask-auto-encoder.md) â€” MAE deploy workflow for TensorRT engine generation using TAO Deploy.
