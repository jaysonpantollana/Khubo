---
name: makepad-font
description: "Use when working with makepad-font"
---
...
description: |
  ...
  makepad å­—ä½“, makepad æ–‡å­—, makepad æŽ’ç‰ˆ, makepad å­—å½¢
risk: safe
source: community
---
...
2. If file read fails or file is empty:
   - Inform user: "æœ¬åœ°æ–‡æ¡£ä¸å®Œæ•´ï¼Œå»ºè®®è¿è¡Œ `/sync-crate-skills makepad --force` æ›´æ–°æ–‡æ¡£"
...
```
draw/src/text/
â”œâ”€â”€ font.rs           # Font handle and metrics
â”œâ”€â”€ font_atlas.rs     # GPU texture atlas for glyphs
â”œâ”€â”€ font_face.rs      # Font face data
â”œâ”€â”€ font_family.rs    # Font family management
â”œâ”€â”€ fonts.rs          # Built-in fonts
â”œâ”€â”€ glyph_outline.rs  # Glyph vector outlines
â”œâ”€â”€ glyph_raster_image.rs # Rasterized glyph images
â”œâ”€â”€ layouter.rs       # Text layout engine
â”œâ”€â”€ rasterizer.rs     # Glyph rasterization
â”œâ”€â”€ sdfer.rs          # Signed distance field generator
â”œâ”€â”€ selection.rs      # Text selection/cursor
â”œâ”€â”€ shaper.rs         # Text shaping (harfbuzz)
```
