...
description: "Use when working with mcore-linting-and-formatting"
---
...
This installs `ruff`, `black`, `isort`, `pylint` â€” the same tools used by
...
- **Naming**: follow Python conventions â€” `snake_case` for functions and variables, `PascalCase` for classes.
