...
> Generated by [Spartan AI Toolkit](https://github.com/c0x12c/ai-toolkit)
...
- **phase-reviewer**: |
- **micronaut-backend-expert**: Use this agent when you need expert guidance on backend development with the Micronaut framework, database design decisions, API architecture, or when bridging backend and frontend concerns
- **solution-architect-cto**: Use this agent when you need strategic technical guidance, architectural decisions, technology stack recommendations, system design reviews, scalability planning, technical debt assessment, team structure advice, or high-level technical leadership
- **design-critic**: |
- **ai-designer**: UI/UX designer that uses external AI (Gemini) for design ideation and asset generation, then produces design docs and prototypes
- **infrastructure-expert**: Use this agent when you need expert guidance on AWS infrastructure with Terraform, including VPC design, EKS/ECS clusters, RDS databases, ElastiCache, S3, IAM, and OIDC patterns
- **sre-architect**: Use this agent when you need strategic infrastructure guidance, multi-account AWS strategy, cost optimization, disaster recovery planning, or environment architecture decisions
