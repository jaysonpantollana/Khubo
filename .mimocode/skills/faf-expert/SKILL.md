---
name: faf-expert
description: "Use when working with faf-expert"
---
...
### ðŸ† Championship Scoring System
...
### ðŸ“Š Mk4 Architecture Framework
...
- âœ… **Cursor** - .cursorrules sync
- âœ… **Gemini CLI** - GEMINI.md sync  
- âœ… **Windsurf** - .windsurfrules support
- âœ… **Universal** - Works with any AI that reads YAML
...
- âœ… Automated stack detection

Use `faf-expert` for:
- ðŸŽ¯ Fine-tuned configuration
- ðŸŽ¯ Championship scoring optimization
- ðŸŽ¯ Multi-platform sync management
- ðŸŽ¯ Enterprise deployment patterns
- ðŸŽ¯ Advanced MCP server setup
