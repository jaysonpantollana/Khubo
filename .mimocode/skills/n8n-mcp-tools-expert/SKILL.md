...
description: "Use when working with n8n-mcp-tools-expert"
---
...
1. **Node Discovery** â†’ SEARCH_GUIDE.md
2. **Configuration Validation** â†’ VALIDATION_GUIDE.md
3. **Workflow Management** â†’ WORKFLOW_GUIDE.md
