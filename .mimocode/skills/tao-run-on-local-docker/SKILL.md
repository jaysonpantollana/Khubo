...
description: "Use when working with tao-run-on-local-docker"
---
...
# Mode 1 â€” direct docker (no Python). All you need is docker + the GPU runtime.
...
# Mode 2 â€” TAO SDK wrapper. Adds Job handles, S3 I/O wrapping, ActionWorkflow.
...
`docker run` directly â€” no SDK install required.
