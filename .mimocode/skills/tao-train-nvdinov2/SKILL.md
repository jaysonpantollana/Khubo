...
description: "Use when working with tao-train-nvdinov2"
---
...
- `sync_batchnorm` is always enabled â€” critical for SSL training with teacher-student framework
...
- [tao-deploy-nvdinov2](references/tao-deploy-nvdinov2.md) â€” NvDINOv2 deploy workflow for TensorRT engine generation using TAO Deploy.
