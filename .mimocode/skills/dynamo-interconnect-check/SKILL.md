...
description: "Use when working with dynamo-interconnect-check"
---
...
absent. Missing here is only a warning â€” they may be baked into the image â€” so
...
pairwise prefillâ†”decode transfer test. A full cross-pod transfer test requires
...
- Single-node agg deployments do not exercise the transport â€” this skill is for disagg / multi-node validation.
...
- `references/interconnect-env-vars.md` â€” NIXL/UCX/NCCL env var catalog and IB
