---
name: form-cro
description: "Use when working with form-cro"
---

---
name: form-cro
description: Optimize any form that is NOT signup or account registration â€” including lead capture, contact, demo request, application, survey, quote, and checkout forms.
risk: unknown
source: community
...
* â€œjust make it shorterâ€ mistakes

---

## ðŸ”¢ Form Health & Friction Index
...
#### 1. Field Necessity & Efficiency (0â€“30)

* Every required field is justified
* No unused or â€œnice-to-haveâ€ fields
* No duplicated or inferable data

---

#### 2. Valueâ€“Effort Balance (0â€“20)
...
#### 3. Cognitive Load & Clarity (0â€“20)
...
#### 4. Error Handling & Recovery (0â€“15)
...
#### 5. Trust & Friction Reduction (0â€“10)
...
| ------ | ------------------------ | -------------------------------- |
| 85â€“100 | **High-Performing**      | Optimize incrementally           |
| 70â€“84  | **Usable with Friction** | Clear optimization opportunities |
| 55â€“69  | **Conversion-Limited**   | Structural issues present        |
...
* What qualifies as a â€œgoodâ€ submission?
...
* 3 fields â†’ baseline
* 4â€“6 fields â†’ âˆ’10â€“25%
* 7+ fields â†’ âˆ’25â€“50%+
...
* Single â€œNameâ€ field by default
...
Bad: â€œInvalid inputâ€
Good: â€œPlease enter a valid email ([name@company.com](mailto:name@company.com))â€
...
* **signup-flow-cro** â€“ Account creation forms
* **popup-cro** â€“ Forms in modals
* **page-cro** â€“ Page-level optimization
* **analytics-tracking** â€“ Measuring form performance
* **ab-test-setup** â€“ Testing form changes
