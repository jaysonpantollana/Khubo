---
name: fp-types-ref
description: "Use when working with fp-types-ref"
---
...
â”œâ”€ NO: Does it involve errors?
â”‚   â”œâ”€ YES â†’ Either<Error, Value>
â”‚   â””â”€ NO: Might value be missing?
â”‚       â”œâ”€ YES â†’ Option<Value>
â”‚       â””â”€ NO â†’ Just use the value
â””â”€ YES: Does it involve errors?
    â”œâ”€ YES â†’ TaskEither<Error, Value>
    â””â”€ NO: Might value be missing?
        â”œâ”€ YES â†’ TaskOption<Value>
        â””â”€ NO â†’ Task<Value>
```
