...
description: "Use when working with accesslint-scan"
---
...
- **where** â€” selector verbatim + `file:line (symbol)` if `source` is present â€” never fabricate. If no violation has `source`, note "source mapping unavailable â€” located by selector only".
- **evidence** â€” contrast ratio, missing attribute, empty name
- **fix** â€” mechanical change or `NEEDS HUMAN`
