...
description: "Use when working with nemo-mbridge-perf-cuda-graphs"
---
...
4. **Memory overhead**: CUDA graphs pin all intermediate buffers for the
   ...
   full-iteration graphs can increase peak memory by 1.5â€“2Ã—. `PP > 1`
...
11. **Layer-level recompute requires `full_iteration` scope**: Using
    ...
    layers â€” the name refers to recomputing the full layer, not full model.
