...
description: "Use when working with environment-setup-guide"
---
...
# Check prerequisites
command -v node >/dev/null 2>&1 || { echo "âŒ Node.js not installed"; exit 1; }
command -v git >/dev/null 2>&1 || { echo "âŒ Git not installed"; exit 1; }
