...
description: "Use when working with vibers-code-review"
---
...
# Vibers â€” Human Code Review for AI-Generated Projects
...
Go to your repo â†’ Settings â†’ Collaborators â†’ Add **`marsiandeployer`**
...
| `telegram_contact` | Your Telegram â€” we'll message you when review is ready |
...
1. You push code â†’ GitHub Action sends us the commit details
...
- Moltbook: [moltbook.com](https://moltbook.com) â€” user **noxon**
...
Yes â€” write to Telegram with your code and spec.
