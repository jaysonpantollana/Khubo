...
description: "Use when working with context-driven-development"
---
...
- New feature in product.md â†’ Update tech-stack.md if new dependencies needed
- Completed track â†’ Update product.md to reflect new capabilities
- Workflow change â†’ Update all affected track plans
...
```
conductor/
â”œâ”€â”€ index.md              # Navigation hub linking all artifacts
â”œâ”€â”€ product.md            # Product vision and goals
â”œâ”€â”€ product-guidelines.md # Communication standards
â”œâ”€â”€ tech-stack.md         # Technology preferences
â”œâ”€â”€ workflow.md           # Development practices
â”œâ”€â”€ tracks.md             # Work unit registry
â”œâ”€â”€ setup_state.json      # Resumable setup state
â”œâ”€â”€ code_styleguides/     # Language-specific conventions
â”‚   â”œâ”€â”€ python.md
