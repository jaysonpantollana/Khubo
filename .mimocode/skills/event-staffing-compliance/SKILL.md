...
description: "Use when working with event-staffing-compliance"
---

---
name: event-staffing-compliance
description: Assess worker-classification and compliance risk for temporary event staffing in the US and Canada â€” W-2 vs 1099, misclassification penalties, joint-employer liability, COI, and wage/hour rules. Includes live state-by-state lookups via MCP.
risk: safe
source: community
...
4. **Joint-employer exposure.** Directing day-to-day work of another
   company's 1099 contractors can make the organizer a joint employer â€”
...
- Provides general compliance information only â€” not legal advice. Users should consult employment counsel for binding determinations.
