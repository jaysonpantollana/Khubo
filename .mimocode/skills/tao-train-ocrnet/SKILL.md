...
description: "Use when working with tao-train-ocrnet"
---
...
- No explicit `num_nodes` in train script â€” single-node oriented
...
- [tao-deploy-ocrnet](references/tao-deploy-ocrnet.md) â€” OCRNet deploy workflow for TensorRT engine generation, TensorRT evaluation, and TensorRT inference using TAO Deploy.
