...
description: "Use when working with vibe-code-auditor"
---
...
Before beginning the audit, confirm the following. If any item is missing, state what is absent and proceed with the available information â€” do not halt.
...
```
1. [P1 - Blocker] Fix title â€” addresses [CRITICAL #1] â€” effort: S/M/L â€” impact: prevents [specific failure]
2. [P2 - Blocker] Fix title â€” addresses [CRITICAL #2] â€” effort: S/M/L â€” impact: prevents [specific failure]
3. [P3 - High] Fix title â€” addresses [HIGH #1] â€” effort: S/M/L â€” impact: improves [specific metric]
4. [P4 - Medium] Fix title â€” addresses [MEDIUM #1] â€” effort: S/M/L â€” impact: reduces [specific debt]
5. [P5 - Optional] Fix title â€” addresses [LOW #1] â€” effort: S/M/L â€” impact: nice-to-have
```
...
- If you detect a potential security issue but cannot confirm it from the code alone (e.g., depends on framework configuration not shown), flag it as "unconfirmed â€” verify" rather than omitting or overstating it.
