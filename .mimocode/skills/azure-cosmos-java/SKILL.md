...
description: "Use when working with azure-cosmos-java"
---
...
1. **Reuse CosmosClient** â€” Create once, reuse throughout application
2. **Use async client** for high-throughput scenarios
3. **Choose partition key carefully** â€” Affects performance and scalability
