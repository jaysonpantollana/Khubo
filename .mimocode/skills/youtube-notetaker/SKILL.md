...
description: "Use when working with youtube-notetaker"
---
...
default. **Do not use em dashes (â€”) or arrows (â†’) in notes/titles.**
...
```
Uses `yt-dlp` to grab the video (â‰¤720p is plenty for slide frames) and the best available
...
`$VIDEO_LIBRARY_DIR/_media/` as `<YTID>-slide-01.jpg`, `-02.jpg`, â€¦ (numbered in time order).
