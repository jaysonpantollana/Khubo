---
name: videodb-skills
description: "Use when working with videodb-skills"
---
...
The only video skill your agent needs. Upload any video, connect real-time streams, search inside by what was said or shown, build complex editing workflows with overlays, generate AI media, add subtitles, and get instant streaming links â€” all via the VideoDB Python SDK.
...
- User wants to edit clips â€” trim, combine, add text/image/audio overlays
