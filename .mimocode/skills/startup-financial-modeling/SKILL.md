...
description: "Use when working with startup-financial-modeling"
---
...
**Formula:**
```
MRR = Î£ (Cohort Size Ã— Retention Rate Ã— ARPU)
ARR = MRR Ã— 12
```
...
**Revenue Calculation:**
For each cohort, calculate retained customers Ã— ARPU for each month.
...
**Example:**
```
Engineer: $150K salary Ã— 1.35 = $202K fully-loaded
Sales Rep: $100K OTE Ã— 1.30 = $130K fully-loaded
```
...
- Customer acquisition rate (Â±30%)
- Churn rate (Â±20%)
- Average contract value (Â±15%)
- CAC (Â±25%)
