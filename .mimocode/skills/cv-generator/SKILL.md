---
name: cv-generator
description: "Use when working with cv-generator"
---
...
# CV Generator Skill â€” FlowCV / Canva Edition
...
version formatted for FlowCV, Canva, Google Docs, or Word â€” with a flaw report and
missing-info checklist.

---

## FLAW REGISTER â€” KNOWN ISSUES FIXED IN THIS VERSION
...
| F-06 | ATS check listed but had no scored output | Flaw report now scores 0â€“100 with per-item pass/fail |
...
| F-09 | Tense rules stated but never verified in quality gate | Tense check is now a hard gate â€” output blocked until corrected |
...
Use @cv-generator â€” I want a FlowCV-ready output.
```
...
| # | Source | Instruction |
|---|--------|-------------|
| 1 | LinkedIn profile URL | Fetch page; extract all visible sections. **If blocked or empty: immediately ask for a LinkedIn PDF â€” do not proceed on an empty extraction.** |
...
| 5 | Existing CV or draft | Upload or paste; improve only â€” never alter facts. |
...
> "I've assumed mid-level (3â€“8 years). Let me know if this should be different."

| Level | Years | CV emphasis |
|-------|-------|-------------|
| Student / fresh graduate | 0â€“1 | Education first; projects; extracurriculars; 1 page |
| Junior / entry | 1â€“3 | Skills + education prominent; 1 page |
| Mid-level | 3â€“8 | Experience leads; achievements over duties; 1â€“2 pages |
| Senior | 8â€“15 | Leadership, scope, impact, mentoring; 2 pages |
| Executive / C-suite | 15+ | Strategic narrative; board roles; P&L; 2â€“3 pages |
...
> (LinkedIn â†’ Me â†’ Settings â†’ Data Privacy â†’ Get a copy of your data) and upload it."

If accessible, extract in order:
1. Full name and headline
2. Contact information (email, phone, location â€” public only)
...
- If a section is absent, mark it **[Not provided]** â€” do not skip silently.
...
Extract:
- About / bio â†’ Professional Summary
- Projects: name, description, technologies, outcomes, live/repo URLs
- Skills and services
- Testimonials or client logos â†’ Achievements
- Case studies â†’ 2â€“4 bullets each
- Blog posts or articles â†’ Publications / Thought Leadership
- Contact details
...
Q8.  Professional summary â€” describe yourself in 2â€“3 sentences (will be rewritten)
Q9.  Work experience â€” for EACH role:
       - Job title
       - Company name and industry
       - Employment type (full-time / part-time / contract / freelance / internship)
       - Location or Remote
       - Start and end date (or "Present")
       - 3â€“6 key responsibilities and achievements
       - Any measurable results (numbers, %, revenue, team size, budget)
Q10. Education â€” for EACH qualification:
...
Q20. Any employment gaps? Dates and brief reason â€” will be framed constructively.
```
...
- Improve ATS keyword density where natural â€” do not keyword-stuff.
...
Extract:
- Bio / tagline â†’ supplement Professional Summary
...
**Gap 3â€“12 months:** one-line entry:
> "Career break â€” [brief honest reason: personal development / caregiving / travel / health]"
...
**Fresh graduate:** lead with Education â†’ Projects â†’ Skills â†’ Internships.
...
5. Never fabricate a detail â€” mark it **[Not provided]** until the user confirms.

---

## CV section order

### Chronological (default â€” mid / senior)
```
1.  Full Name
...
4.  Key Achievements
5.  Work History (company, title, dates â€” minimal bullets)
6.  Education
7.  Certifications
8.  Languages
```
...
Write 3â€“5 sentences (executive: 5â€“7) covering:
...
- Base strictly on data collected â€” no padding.
...
> costs 30â€“40% through cloud-native redesigns. Seeking a staff-level role where
> systems reliability and platform engineering intersect."

### Experience bullets â€” STAR-lite

Pattern: `[Strong verb] + [what you did] + [scale/scope] + [outcome if available]`

Rules:
- 3â€“6 bullets per role (2â€“3 for short-tenure or early roles)
- Past tense for completed roles; present tense for current role
- 15â€“30 words per bullet
- Different verb to open each bullet â€” never repeat within one role
- If no metric was provided: write a result-focused statement without inventing numbers
- Never fabricate metrics â€” if the user says "we grew a lot", ask for specifics
...
### Banned phrases â€” machine-checkable blocklist
...
This is a hard gate â€” output is blocked until tense is correct:

- **Completed role** â†’ all bullets in past tense (Led, Built, Reduced...)
- **Current role** â†’ all bullets in present tense (Lead, Build, Reduce...)
- **Mixed tense within one role** â†’ always fail; fix before output
...
| No icons in bullets or headings | Symbols like âž¤ âœ“ â˜… corrupt parsed text |
| Bullet characters: hyphen (-) or plain dot (â€¢) only | Safe across all ATS platforms |
...
| Font: minimum 10pt body, 12â€“14pt headings | Smaller text garbles in PDF-to-text conversion |
...
1. Extract top 10â€“20 keywords from the JD (if provided).
2. Categorise: hard skills | soft skills | qualifications | industry terms.
3. For each keyword, record:
   - Present and prominent
   - Present but weak or buried â†’ strengthen placement
   - Absent but user has the skill â†’ weave in naturally
   - Absent and user lacks the skill â†’ do not add
4. Target keyword density: 2â€“4 natural occurrences per hard skill across the full CV.
...
| Item | Rule |
|------|------|
| Job titles | Sourced directly from user data â€” not inferred or upgraded |
| Company names | Sourced directly â€” not corrected, normalised, or embellished |
| Dates | Reproduced exactly as provided â€” no normalisation without noting it |
| Degrees and institutions | Reproduced exactly as provided |
| Certifications | Only those explicitly named by the user |
| Metrics and numbers | Only those provided by the user â€” never approximated or invented |
...
## Final output â€” deliver in this exact order
...
PROFESSIONAL SUMMARY
[3â€“5 sentence plain paragraph â€” no bullets, no Markdown]
...
[Job Title]
[Company Name] | [City, Country] | [Mon YYYY] â€“ [Mon YYYY or Present]
...
[Degree Name]
[Institution Name], [Country] | [YYYY] â€“ [YYYY]
[Grade or classification if notable]

[Repeat for each qualification]

CERTIFICATIONS
[Certificate Name] â€” [Issuing Body] â€” [Month YYYY]
...
[Role] â€” [Organisation] â€” [YYYYâ€“YYYY]
...
[3â€“5 sentence paragraph, plain text, no hyphens or bullets]
...
[Job Title]
[Company] | [Location] | [Mon YYYY â€“ Mon YYYY]
- [Bullet]
- [Bullet]
- [Bullet]
...
[Degree]
[Institution], [Country] | [YYYY â€“ YYYY]
[Grade if notable]
...
[ ] Certifications â€” do you hold any?
[ ] Languages â€” list any beyond English
[ ] Employment gap [Mon YYYY â€“ Mon YYYY] â€” add a brief framing note
[ ] [Any other flagged item]
```

### CV flaw report (scored 0â€“100)
...
PASS  Truthfulness â€” all facts sourced from user data
PASS  No hallucination â€” no fabricated details
PASS  Tense correctness â€” past for completed, present for current
PASS  ATS structure â€” single column, no tables or images
PASS  Standard headings â€” all recognisable by parsers
PASS  No forbidden characters â€” no âž¤ âœ“ â˜…
PASS  Humanized â€” no banned phrases found
PASS  Contact info in body (not header/footer)
FAIL  [Check name] â€” [specific issue and location in CV]
â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
Deductions: -[N] per FAIL item
Final score: [X]/100

ISSUES TO FIX:
1. [Exact location] â€” [Exact problem] â€” [Suggested fix]
2. [Exact location] â€” [Exact problem] â€” [Suggested fix]
```
...
### Improvement suggestions (3â€“7, specific and actionable)
...
- "Add a GitHub or portfolio URL â€” technical recruiters check it before the interview."
- "Three bullets begin with 'Responsible for' â€” replace with direct action verbs."
...
If yes, output as a **separate clearly labelled plain-text block** â€” not inline with the CV.

Rules:
- Opens with a specific hook â€” not "I am writing to apply forâ€¦"
- References company and role by name
- Bridges 2â€“3 strongest CV points to the JD's key requirements
- Closes with a clear call to action
- Matches tone of the target industry
- 3 paragraphs maximum, 250â€“350 words
...
- **No fake metrics.** If the user says "we grew a lot", ask for specifics â€” never insert a percentage.
- **Respect source truth.** "Junior Developer" stays "Junior Developer" â€” suggest a reframe if needed; never silently change it.
...
- **OCR warning.** Always display before continuing: "OCR was used â€” please verify the extracted text for accuracy."
...
|--------|--------|-------|-----|----------------|------------|
| USA | 1â€“2 pages | No | No | No | "Available on request" |
| Canada | 1â€“2 pages | No | No | No | "Available on request" |
| UK | 2 pages | No | No | No | "Available on request" |
| Ireland | 2 pages | No | No | No | "Available on request" |
| Australia / NZ | 2â€“3 pages | No | No | No | "Available on request" |
| Germany / Austria / Switzerland | 2â€“3 pages | Yes (expected) | Yes | Sometimes | Listed or on request |
| France | 1â€“2 pages | Optional | No (illegal to require) | No | On request |
| Netherlands / Scandinavia | 1â€“2 pages | Optional | No | No | On request |
| Japan | 1â€“2 pages (rirekisho) | Yes | Yes | Yes | Listed |
| South Korea | 1â€“2 pages | Yes | Yes | Yes | Listed |
| China | 1â€“2 pages | Yes | Yes | Yes | Listed |
| India | 2â€“3 pages | Optional | Yes (common) | Sometimes | Listed |
| Nepal | 2â€“3 pages | Yes (common) | Yes | Sometimes | Listed |
| Bangladesh / Sri Lanka | 2â€“3 pages | Yes (common) | Yes | Sometimes | Listed |
| UAE / Gulf (GCC) | 2â€“3 pages | Yes (common) | Yes | Yes (sometimes) | Listed |
| Nigeria / East Africa | 2â€“3 pages | Yes (common) | Yes | Sometimes | Listed |
| South Africa | 3â€“5 pages | Optional | Yes (common) | No | Listed |
| Brazil | 1â€“2 pages | Optional | Yes (common) | No | On request |
| Academic (global) | No limit | Varies | Varies | No | Full list required |
| Executive / board (global) | 2â€“3 pages | No | No | No | On request |
...
User invokes @cv-generator
        |
        v
Source provided? --No--> Run questionnaire (Q1â€“Q20, one at a time)
        |Yes
        v
