        ...
        >
          ...
          <div className="p-6 flex-1 overflow-y-auto flex flex-col">
            ...
            <div className="overflow-x-auto w-full p-1 flex-1">
              <table className="w-full text-left border-collapse border-spacing-y-2 h-full">
                <thead>
                  <tr className="border-b border-neutral-100 bg-neutral-50/50">
                    ...
                    <th className="p-4 text-neutral-500 font-bold text-sm">Phone</th>
                    <th className="p-4 text-neutral-500 font-bold text-sm">Social</th>
                  </tr>
                </thead>
                <tbody>
