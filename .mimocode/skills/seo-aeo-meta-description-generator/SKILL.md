...
description: "Use when working with seo-aeo-meta-description-generator"
---
...
- **V1 Benefit Lead** â€” leads with the outcome or benefit
- **V2 Question Hook** â€” opens with the question the searcher is asking
- **V3 Social Proof / Specificity** â€” leads with a number, stat, or specific claim

### Step 2: Apply Character Limits
- Title tag: 50â€“60 characters (hard limit: 60)
- Meta description: 140â€“155 characters (hard limit: 160)
...
OG and Twitter tags can be more conversational than SERP tags. Write them as distinct copy â€” not copy-pastes of the meta description.

## Examples

### Example 1: Landing Page Variants
Title V1: Remote Project Management Software | Syncro
(51 chars) â€” Keyword first, brand at end
Title V2: Manage Remote Teams Without the Chaos | Syncro
(54 chars) â€” Pain-point led with power word
...
- âœ… **Do:** Write 3 variants â€” always give the user options to test
- âœ… **Do:** Keep OG and Twitter descriptions more conversational than SERP versions
- âœ… **Do:** Verify character count on every variant before outputting
- âŒ **Don't:** Use the same exact-match anchor or keyword more than once per description
- âŒ **Don't:** Copy-paste the meta description into the OG description
- âŒ **Don't:** Let any description end mid-sentence near the character limit
...
- **Problem:** All 3 variants sound identical
  **Solution:** Each variant must use a genuinely different CTR mechanic â€” not just rearranged words.

## Related Skills

- `@seo-aeo-landing-page-writer` â€” provides the page content this skill writes tags for
- `@seo-aeo-content-quality-auditor` â€” verifies meta elements as part of the full audit
