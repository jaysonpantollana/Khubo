---
name: ui-rules
description: Concise MUST/SHOULD/NEVER rules for building accessible, fast, delightful UIs. Use when building or reviewing React/Next.js components, forms, animations, layouts, or accessibility.
---
