...
description: "Use when working with startup-business-analyst-financial-projections"
---
...
3. Revenue per cohort (customers Ã— ARPU)
4. Expansion revenue (upsells)

**Formula:**
```
MRR (Month N) = Î£ across all cohorts:
  (Cohort Size Ã— Retention Rate Ã— ARPU) + Expansion
```
...
- Base salary
- Fully-loaded cost (salary Ã— 1.3-1.4)
- Equity grant
...
â†’ "B2B SaaS, subscription-based"

Current state?
â†’ "$50K MRR, 100 customers, 5-person team, $500K cash"

Growth assumptions?
â†’ "Expect 15% MoM growth, 10% monthly churn, $500 ACV"
