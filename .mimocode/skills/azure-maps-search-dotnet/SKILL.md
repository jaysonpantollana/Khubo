...
description: "Use when working with azure-maps-search-dotnet"
---
...
```
Azure.Maps.Search
â””â”€â”€ MapsSearchClient
    â”œâ”€â”€ GetGeocoding()                    â†’ Geocode addresses
    â”œâ”€â”€ GetGeocodingBatch()               â†’ Batch geocoding
    â”œâ”€â”€ GetReverseGeocoding()             â†’ Coordinates to address
    â”œâ”€â”€ GetReverseGeocodingBatch()        â†’ Batch reverse geocoding
    â””â”€â”€ GetPolygon()                      â†’ Get boundary polygons

Azure.Maps.Routing
â””â”€â”€ MapsRoutingClient
    â”œâ”€â”€ GetDirections()                   â†’ Route directions
    â”œâ”€â”€ GetImmediateRouteMatrix()         â†’ Route matrix (sync, â‰¤100)
    â”œâ”€â”€ GetRouteMatrix()                  â†’ Route matrix (async, â‰¤700)
    â””â”€â”€ GetRouteRange()                   â†’ Isochrone/reachable range

Azure.Maps.Rendering
â””â”€â”€ MapsRenderingClient
    â”œâ”€â”€ GetMapTile()                      â†’ Map tiles
    â”œâ”€â”€ GetMapStaticImage()               â†’ Static map images
    â””â”€â”€ GetCopyrightCaption()             â†’ Copyright info

Azure.Maps.Geolocation
â””â”€â”€ MapsGeolocationClient
    â””â”€â”€ GetCountryCode()                  â†’ IP to country/region

Azure.Maps.Weather
â””â”€â”€ MapsWeatherClient
    â”œâ”€â”€ GetCurrentWeatherConditions()     â†’ Current weather
    â”œâ”€â”€ GetDailyForecast()                â†’ Daily forecast
    â”œâ”€â”€ GetHourlyForecast()               â†’ Hourly forecast
    â””â”€â”€ GetSevereWeatherAlerts()          â†’ Weather alerts
```
...
1. **Use Entra ID for production** â€” Prefer over subscription keys
2. **Batch operations** â€” Use batch geocoding for multiple addresses
3. **Cache results** â€” Geocoding results don't change frequently
4. **Use appropriate tile sizes** â€” 256 or 512 pixels based on display
5. **Handle rate limits** â€” Implement exponential backoff
6. **Use async route matrix** â€” For large matrix calculations (>100)
7. **Consider traffic data** â€” Set `UseTrafficData = true` for accurate ETAs
