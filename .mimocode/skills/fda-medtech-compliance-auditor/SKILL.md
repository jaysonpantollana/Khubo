...
description: "Use when working with fda-medtech-compliance-auditor"
---
...
**Scenario:** A CAPA was opened for a software defect in a Class II device. The documented root cause is â€œdeveloper error â€” unclear requirements.â€ The corrective action is developer retraining.
...
process itself â€” not an individual.
...
- âœ… **Do:** Provide exact wording from SOPs, risk tables, or validation plans for the most accurate review.
- âœ… **Do:** Expect strict interpretations â€” the goal is to find weaknesses before a real inspector does.
- âŒ **Don't:** Forget to link every software defect to a clinical risk item in your ISO 14971 risk file.
- âŒ **Don't:** Assume "we tested it and it works" satisfies IEC 62304 software verification requirements.
