---
name: qiskit
description: "Use when working with qiskit"
---
...
- Install Qiskit or set up IBM Quantum account â†’ `references/setup.md`
- Build a new quantum circuit â†’ `references/circuits.md`
- Understand gates and circuit operations â†’ `references/circuits.md`
- Run circuits and get measurements â†’ `references/primitives.md`
- Compute expectation values â†’ `references/primitives.md`
- Optimize circuits for hardware â†’ `references/transpilation.md`
- Visualize circuits or results â†’ `references/visualization.md`
- Execute on IBM Quantum hardware â†’ `references/backends.md`
- Connect to third-party providers â†’ `references/backends.md`
- Implement end-to-end quantum workflow â†’ `references/patterns.md`
- Build specific algorithm (VQE, QAOA, etc.) â†’ `references/algorithms.md`
- Solve chemistry or optimization problems â†’ `references/algorithms.md`
