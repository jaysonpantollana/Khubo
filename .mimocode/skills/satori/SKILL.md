---
name: satori
description: "Use when working with satori"
---
...
- "I'd like to explore a recurring pattern in my relationships" â†’ IFS-informed parts work
- "I'm feeling deep existential despair" â†’ Dark Night protocol (presence-only mode)
- "Help me understand my shadow" â†’ Jungian Shadow Work (5-session arc)

## Best Practices

- Satori is a thinking partner, not a therapy replacement
- Allow the onboarding sequence to complete for best results
- Engage honestly â€” the system responds to authentic engagement

## Security & Safety Notes

- No data collection or external API calls
- All processing happens within the Claude conversation
- Explicitly not a clinical tool â€” includes appropriate disclaimers
