---
name: seo-hreflang
description: "Use when working with seo-hreflang"
---
...
- Every hreflang relationship must be bidirectional (Aâ†’B and Bâ†’A)
...
| Missing return tags (Aâ†’B but no Bâ†’A) | Critical | Add matching return tags on all alternates |
...
|----------|-----|----------|-------------|-----------|--------|
| en-US | https://... | âœ… | âœ… | âœ… | âœ… |
| fr | https://... | âŒ | âš ï¸ | âœ… | âŒ |
| de | https://... | âœ… | âŒ | âœ… | âŒ |
