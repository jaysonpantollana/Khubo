                        ...
                        >
                          <div className="space-y-2 md:space-y-3">
                            ...
                            <button
                              ...
                              className="w-full flex items-center justify-center gap-1.5 py-2 text-xs md:text-sm font-semibold text-[#2252D6] hover:bg-[#2252D6]/5 rounded-lg transition-colors"
                            >
