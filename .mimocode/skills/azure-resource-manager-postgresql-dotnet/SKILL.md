...
description: "Use when working with azure-resource-manager-postgresql-dotnet"
---
...
Subscription
â””â”€â”€ ResourceGroup
    â””â”€â”€ PostgreSqlFlexibleServer              # PostgreSQL Flexible Server instance
        â”œâ”€â”€ PostgreSqlFlexibleServerDatabase  # Database within the server
        â”œâ”€â”€ PostgreSqlFlexibleServerFirewallRule # IP firewall rules
        â”œâ”€â”€ PostgreSqlFlexibleServerConfiguration # Server parameters
        â”œâ”€â”€ PostgreSqlFlexibleServerBackup    # Backup information
        â”œâ”€â”€ PostgreSqlFlexibleServerActiveDirectoryAdministrator # Entra ID admin
        â””â”€â”€ PostgreSqlFlexibleServerVirtualEndpoint # Read replica endpoints
```
...
1. **Use Flexible Server** â€” Single Server is deprecated
2. **Enable zone-redundant HA** â€” For production workloads
3. **Use DefaultAzureCredential** â€” Prefer over connection strings
4. **Configure Entra ID authentication** â€” More secure than SQL auth alone
5. **Enable both auth methods** â€” Entra ID + password for flexibility
6. **Set appropriate backup retention** â€” 7-35 days based on compliance
7. **Use private endpoints** â€” For secure network access
8. **Tune server parameters** â€” Based on workload characteristics
9. **Use read replicas** â€” For read-heavy workloads
10. **Stop dev/test servers** â€” Save costs when not in use
