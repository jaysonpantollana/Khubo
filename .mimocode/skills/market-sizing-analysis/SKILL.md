...
description: "Use when working with market-sizing-analysis"
---
...
SAM = TAM Ã— Geographic % Ã— Segment %
SOM = SAM Ã— Realistic Capture Rate (2-5%)
```
...
**Formula:**
```
TAM = Î£ (Segment Size Ã— Annual Revenue per Customer)
SAM = TAM Ã— (Segments You Can Serve / Total Segments)
SOM = SAM Ã— Realistic Penetration Rate (Year 3-5)
```
...
**Formula:**
```
Value per Customer = Problem Cost Ã— % Solved by Solution
Price per Customer = Value Ã— Willingness to Pay % (10-30%)
TAM = Total Potential Customers Ã— Price per Customer
SAM = TAM Ã— % Meeting Buy Criteria
SOM = SAM Ã— Realistic Adoption Rate
```
...
**Formula:**
```
SAM = TAM Ã— (% matching all filters)
```
...
- SAM = $10B Ã— 0.40 Ã— 0.30 Ã— 0.60 = $720M
...
**Example:**
- SAM: $720M
- Year 3 SOM: $720M Ã— 2% = $14.4M
- Year 5 SOM: $720M Ã— 5% = $36M
...
**TAM Calculation:**
```
TAM = Total Target Companies Ã— Average ACV Ã— (1 + Expansion Rate)
```
...
**TAM Calculation:**
```
TAM = Total Category GMV Ã— Expected Take Rate
```
...
**TAM Calculation:**
```
TAM = Total Users Ã— ARPU Ã— Purchase Frequency per Year
```
...
**TAM Calculation:**
```
TAM = Total Target Companies Ã— Average Deal Size Ã— Deals per Year
```
