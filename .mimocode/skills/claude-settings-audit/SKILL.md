...
description: "Use when working with claude-settings-audit"
---
...
- `pyproject.toml` â†’ check `[project.dependencies]` or `[tool.poetry.dependencies]`
- `Gemfile` â†’ check gem names
