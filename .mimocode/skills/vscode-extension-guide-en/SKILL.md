...
description: "Use when working with vscode-extension-guide-en"
---
...
â”œâ”€â”€ images/icon.png       # 128x128 PNG for Marketplace
â””â”€â”€ .vscodeignore         # Exclude files from VSIX
```
