---
name: writing-skills
description: "Use when working with writing-skills"
---
...
1. **Create a NEW skill:**
   - Is it simple (single file, <200 lines)? â†’ [Tier 1 Architecture](references/tier-1-simple/README.md)
   - Is it complex (multi-concept, 200-1000 lines)? â†’ [Tier 2 Architecture](references/tier-2-expanded/README.md)
   - Is it a massive platform (10+ products, AWS, Convex)? â†’ [Tier 3 Architecture](references/tier-3-platform/README.md)
...
1. **Identify goal** â†’ Use decision tree above
2. **Select template** â†’ From `references/templates/`
3. **Apply CSO** â†’ Optimize description for discovery
4. **Add anti-rationalization** â†’ For discipline skills
5. **Test** â†’ RED-GREEN-REFACTOR cycle
