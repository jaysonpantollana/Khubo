...
description: "Use when working with vercel-cli-with-tokens"
---

---
name: vercel-cli-with-tokens
description: "Deploy and manage projects on Vercel using token-based authentication. Use when working with Vercel CLI using access tokens rather than interactive login â€” e.g. \"deploy to vercel\", \"set up vercel\", \"add environment variables to vercel\"."
risk: safe
...
## When to Use
- Use this skill when the task matches this description: Deploy and manage projects on Vercel using token-based authentication. Use when working with Vercel CLI using access tokens rather than interactive login â€” e.g. "deploy to vercel", "set up vercel", "add environment variables to vercel".
