...
description: "Use when working with app-store-changelog"
---
...
|---|---|
| `fix(auth): resolve token refresh race condition on iOS 17` | â€¢ Fixed a login issue that could leave some users unexpectedly signed out. |
| `feat(search): add voice input to search bar` | â€¢ Search your library hands-free with the new voice input option. |
| `perf(timeline): lazy-load images to reduce scroll jank` | â€¢ Scrolling through your timeline is now smoother and faster. |
...
â€¢ Search your library hands-free with the new voice input option.
â€¢ Scrolling through your timeline is now smoother and faster.
â€¢ Fixed a login issue that could leave some users unexpectedly signed out.
â€¢ Added dark-mode support to the settings screen.
â€¢ Improved load times when opening large photo albums.
```
