...
description: "Use when working with backend-dev-guidelines"
---
...
âŒ Business logic in routes
âŒ Skipping service layer
âŒ Direct Prisma in controllers
âŒ Missing validation
âŒ process.env usage
âŒ console.log instead of Sentry
âŒ Untested business logic
