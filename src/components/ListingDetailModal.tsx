    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between p-6 border-b border-neutral-100 shrink-0">
          ...
          <button
            onClick={onClose}
            className="p-2 bg-neutral-100 rounded-full transition-colors text-neutral-500 text-neutral-900 shrink-0"
          >
            <X size={20} />
          </button>
        </div>
          ...
          <div className="relative w-full h-[280px] md:h-[360px] bg-neutral-100 shrink-0">
            ...
            {images.length > 1 && (
              <>
                <button
                  onClick={prevImage}
                  className="absolute left-3 top-1/2 -translate-y-1/2 p-2 bg-white/90 backdrop-blur-sm rounded-full shadow-lg bg-white transition"
                >
                  <ChevronLeft size={20} className="text-neutral-900" />
                </button>
                <button
                  onClick={nextImage}
                  className="absolute right-3 top-1/2 -translate-y-1/2 p-2 bg-white/90 backdrop-blur-sm rounded-full shadow-lg bg-white transition"
                >
