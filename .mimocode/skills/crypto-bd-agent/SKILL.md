...
description: "Use when working with crypto-bd-agent"
---
...
# Crypto BD Agent â€” Autonomous Business Development for Exchanges
...
Built from production experience running Buzz BD Agent by SolCex Exchange â€”
...
Intelligence Sources (Free + Paid via x402)
  ...
  Pipeline Manager (10-stage tracked)
        |
        v
  Outreach Drafts â†’ Human Approval â†’ Send
```
...
3. Track ROI per paid source â€” did this call produce a qualified prospect?
...
1. **Funded-By** â€” Where did deployer get funds? (exchange, mixer, other wallet)
2. **Balances** â€” Current holdings across chains
3. **Transfer History** â€” Dump patterns, accumulation, LP activity
4. **Identity** â€” ENS, social links, KYC indicators
5. **Score Adjustment** â€” Apply flags based on findings

### Wallet Flags

| Flag | Impact |
|------|--------|
| WALLET VERIFIED â€” clean, authorities revoked | +3 to +5 |
| INSTITUTIONAL â€” VC backing | +5 to +10 |
| NET POSITIVE â€” profitable wallet | +2 |
| SERIAL CREATOR â€” many tokens created | -5 |
| DUMP ALERT â€” >50% dump in 7 days | -10 to -15 |
| MIXER REJECT â€” tornado/mixer funded | AUTO REJECT |
...
### 10 Stages
1. Discovered â†’ 2. Scored â†’ 3. Verified â†’ 4. Qualified â†’ 5. Outreach Drafted
â†’ 6. Human Approved â†’ 7. Sent â†’ 8. Responded â†’ 9. Negotiating â†’ 10. Listed

### Required Data for Entry
- Contract address (verified â€” NEVER rely on token name alone)
...
- LLM cascade: MiniMax M2.5 â†’ Llama 70B â†’ Haiku 4.5 â†’ Opus 4.5
