...
description: "Use when working with dotnet-architect"
---
...
```csharp
// âœ… Preferred: Modern C# with clear intent
...
// âœ… Preferred: Record types for DTOs
...
// âœ… Preferred: Expression-bodied members when simple
public string FullName => $"{FirstName} {LastName}";

// âœ… Preferred: Pattern matching
