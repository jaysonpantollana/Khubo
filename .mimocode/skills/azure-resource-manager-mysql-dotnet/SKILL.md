...
description: "Use when working with azure-resource-manager-mysql-dotnet"
---
...
Subscription
â””â”€â”€ ResourceGroup
    â””â”€â”€ MySqlFlexibleServer                 # MySQL Flexible Server instance
        â”œâ”€â”€ MySqlFlexibleServerDatabase     # Database within the server
        â”œâ”€â”€ MySqlFlexibleServerFirewallRule # IP firewall rules
        â”œâ”€â”€ MySqlFlexibleServerConfiguration # Server parameters
        â”œâ”€â”€ MySqlFlexibleServerBackup       # Backup information
        â”œâ”€â”€ MySqlFlexibleServerMaintenanceWindow # Maintenance schedule
        â””â”€â”€ MySqlFlexibleServerAadAdministrator # Entra ID admin
```
...
4. **Configure Entra ID authentication** â€” More secure than SQL auth
5. **Enable auto-grow storage** â€” Prevents out-of-space issues
...
9. **Monitor with Azure Monitor** â€” Enable metrics and logs
