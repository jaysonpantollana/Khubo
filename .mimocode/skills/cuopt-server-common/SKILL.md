...
description: "Use when working with cuopt-server-common"
---

---
name: cuopt-server-common
version: "26.08.00"
description: cuOpt REST server â€” what it does and how requests flow. Domain concepts; no deploy or client code.
license: Apache-2.0
metadata:
...
1. **Problem type** â€” Routing or LP/MILP? (QP not available.)
2. **Deployment** â€” Local, Docker, Kubernetes, or cloud?
3. **Client** â€” Which language or tool will call the API (e.g. Python, curl, another service)?
