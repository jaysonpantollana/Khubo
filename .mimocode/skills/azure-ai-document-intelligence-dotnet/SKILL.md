...
description: "Use when working with azure-ai-document-intelligence-dotnet"
---
...
2. **Reuse client instances** â€” clients are thread-safe
3. **Handle long-running operations** â€” Use `WaitUntil.Completed` for simplicity
4. **Check field confidence** â€” Always verify `Confidence` property
5. **Use appropriate model** â€” Prebuilt for common docs, custom for specialized
6. **Use custom subdomain** â€” Required for Entra ID authentication
