...
description: "Use when working with terraform-skill"
---
...
âŒ DON'T use "this" for multiple resources:
```hcl
...
```hcl
# âœ… GOOD - Removing "us-east-1b" only affects that subnet
...
# âŒ BAD - Removing middle AZ recreates all subsequent subnets
resource "aws_subnet" "private" {
...
â”œâ”€â”€ examples/
â”‚   â”œâ”€â”€ minimal/        # Minimal working example
â”‚   â””â”€â”€ complete/       # Full-featured example
â””â”€â”€ tests/              # Test files
    â””â”€â”€ module_test.tftest.hcl  # Or .go
```
...
- âœ… Use explicit `type` constraints
- âœ… Provide sensible `default` values where appropriate
- âœ… Add `validation` blocks for complex constraints
- âœ… Use `sensitive = true` for secrets

**Outputs:**
- âœ… Always include `description`
- âœ… Mark sensitive outputs with `sensitive = true`
- âœ… Consider returning objects for related values
- âœ… Document what consumers should do with each output

**For detailed module patterns, see:**
- **Module Patterns Guide** - Variable best practices, output design, âœ… DO vs âŒ DON'T patterns
...
- **Module Patterns** - Module structure, variable/output best practices, âœ… DO vs âŒ DON'T patterns
...
**Copyright Â© 2026 Anton Babenko**
