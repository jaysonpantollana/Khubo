...
description: "Use when working with fixing-metadata"
---
...
2. Audit against the priority rules below â€” fix critical issues (duplicates, indexing) first
...
5. Keep diffs minimal and scoped to metadata only â€” do not refactor unrelated code
## When to Use
