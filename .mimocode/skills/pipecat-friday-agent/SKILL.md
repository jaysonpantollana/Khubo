...
description: "Use when working with pipecat-friday-agent"
---
...
- âœ… **Use Silero VAD**: It is robust for local hardware and prevents background noise from triggering the LLM.
- âœ… **Concise Prompts**: Tactical agents should give short, data-dense responses to minimize latency.
- âœ… **Sample Rate Match**: OpenAI TTS outputs at 24kHz; ensure your `audio_out_sample_rate` matches to avoid high-pitched or slowed audio.
- âŒ **No Polite Fillers**: Avoid "Hello, how can I help you today?" Instead, use "Systems nominal. Ready for commands."
