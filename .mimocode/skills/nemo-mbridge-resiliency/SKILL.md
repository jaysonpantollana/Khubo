...
description: "Use when working with nemo-mbridge-resiliency"
---
...
### Fault tolerance
- Config: `src/megatron/bridge/training/config.py` â€” `FaultToleranceConfig`
- Runtime: `src/megatron/bridge/training/fault_tolerance.py`
- Plugin: `src/megatron/bridge/recipes/run_plugins.py` â€” `FaultTolerancePlugin`
...
### Straggler detection
- Config: `src/megatron/bridge/training/config.py` â€” `NVRxStragglerDetectionConfig`
- Runtime: `src/megatron/bridge/training/nvrx_straggler.py`
- Train loop: `src/megatron/bridge/training/train.py` â€” `check_nvrx_straggler_detection`
...
### In-process restart
- Config: `src/megatron/bridge/training/config.py` â€” `InProcessRestartConfig`
- Runtime: `src/megatron/bridge/training/inprocess_restart.py`
- Entry point: `src/megatron/bridge/training/pretrain.py` â€” `maybe_wrap_for_inprocess_restart`
- Tests: `tests/unit_tests/training/test_inprocess_restart.py`, `tests/functional_tests/training/test_inprocess_restart.py`

### Preemption
- Plugin: `src/megatron/bridge/recipes/run_plugins.py` â€” `PreemptionPlugin`
...
- Config: `src/megatron/bridge/training/config.py` â€” `RerunStateMachineConfig`
- Init: `src/megatron/bridge/training/initialize.py` â€” `init_rerun_state`

### Checkpointing
- Async save: `src/megatron/bridge/training/checkpointing.py` â€” `schedule_async_save`
- Local ckpt: `src/megatron/bridge/training/checkpointing.py` â€” `LocalCheckpointManager`
