...
description: "Use when working with skill-rails-upgrade"
---
...
- **Patch upgrade**: Same major.minor, different patch (e.g., 7.1.3 â†’ 7.1.5)
- **Minor upgrade**: Same major, different minor (e.g., 7.1.3 â†’ 7.2.0)
- **Major upgrade**: Different major version (e.g., 7.1.3 â†’ 8.0.0)
...
```
## Upgrade Plan: Rails X.Y.Z â†’ A.B.C
...
- config/application.rb
  â””â”€ Local: i18n configuration
  â””â”€ Rails: [describe new Rails changes if any]

- config/environments/development.rb
  â””â”€ Local: letter_opener mailer config
  â””â”€ Rails: [describe new Rails changes]

- bin/dev
  â””â”€ Local: foreman + Procfile.dev setup
  â””â”€ Rails: changed to simple ruby script
