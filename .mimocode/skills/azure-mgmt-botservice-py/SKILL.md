...
description: "Use when working with azure-mgmt-botservice-py"
---
...
3. **Store MSA App ID/Secret securely** â€” use Key Vault
4. **Enable only needed channels** â€” reduces attack surface
