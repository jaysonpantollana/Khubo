...
description: "Use when working with programmatic-seo"
---
...
- **0â€“15% of band:** No alignment â€” the site/topic clearly does not meet the criterion (e.g. fewer than 10 candidate entities for a directory-style PSEO).
- **16â€“40% of band:** Partial alignment â€” the criterion is partially met, OR met for a small subset of pages only.
- **41â€“80% of band:** Strong alignment â€” the criterion holds for most of the planned page set.
- **81â€“100% of band:** Exemplary â€” the criterion holds universally and is reinforced by a structural data source (DB, API, validated CSV).

Sum the per-category scores to compute the Feasibility Index used in Â§"Feasibility Bands" below.
