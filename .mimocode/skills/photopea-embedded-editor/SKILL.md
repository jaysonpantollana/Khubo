...
description: "Use when working with photopea-embedded-editor"
---
...
**Do NOT** use raw `postMessage` wiring â€” always use `photopea.js` as the wrapper.
...
All methods return Promises â€” always `await` or `.then()`.
...
## Step 2 â€” Opening Files

```js
// Remote URL â†’ new document
await pea.openFromURL("https://example.com/design.psd", false);

// Remote URL â†’ smart object layer inside current document
await pea.openFromURL("https://example.com/overlay.png", true);

// Local file (user input â†’ ArrayBuffer â†’ loadAsset)
...
| `"png"` | PNG lossless |
| `"jpg"` | JPEG default |
| `"jpg:0.8"` | JPEG quality 0.0â€“1.0 |
| `"webp:0.7"` | WebP quality 0.0â€“1.0 |
| `"psd"` | Full PSD |
...
### addImageAndWait â€” robust async layer insertion
```js
...
### getDocumentAsImage â€” returns `<img>` element
```js
...
### Pattern B â€” Template + Text Edit + Export
```js
...
| `app.echoToOE(string)` | **Photopea extension** â€” send string to host page (captured by `runScript`) |
| `app.showWindow("magiccut")` | **Photopea extension** â€” open Magic Cut panel |
| `app.showWindow("vbitmap")` | **Photopea extension** â€” open Vectorize Bitmap panel |
...
| `name` | string | **R/W** | **Photopea extension** â€” display label (no history step) |
| `source` | string | **R/W** | **Photopea extension** â€” file origin URL or `"local,X,NAME"` |
...
| `pixelAspectRatio` | number | R | Custom pixel aspect ratio (0.1â€“10.0) |
...
| `saveToOE` | `(format)` | **Photopea extension** â€” send binary to host. Formats: `"png"`, `"jpg:0.8"`, `"webp:0.7"`, `"psd:true"`, `"svg:true"` |
| `clearHistory` | `()` | **Photopea extension** â€” clear undo history to free RAM |
...
// Resize image to 1920Ã—1080 at 72dpi bicubic
...
| `opacity` | number | R/W | Layer opacity 0â€“100 |
| `fillOpacity` | number | R | Fill opacity 0â€“100 |
...
| `selected` | boolean | R | **Photopea extension** â€” is layer highlighted in panel |
...
| `layerMaskDensity` | number | R | Layer mask density 0â€“100 |
| `layerMaskFeather` | number | R | Layer mask feather 0â€“250 |
| `vectorMaskDensity` | number | R | Vector mask density 0â€“100 |
| `vectorMaskFeather` | number | R | Vector mask feather 0â€“250 |
...
| Method | Signature | Description |
|--------|-----------|-------------|
| `adjustBrightnessContrast` | `(brightness, contrast)` | Brightness -100â€“100, Contrast -100â€“100 |
...
| `posterize` | `(levels)` | Posterize (2â€“255 levels) |
| `threshold` | `(level)` | B&W threshold (1â€“255) |
...
| Method | Signature | Description |
|--------|-----------|-------------|
| `applyGaussianBlur` | `(radius)` | Gaussian blur (0.1â€“250 px radius) |
...
| `applyPinch` | `(amount)` | Pinch (-100â€“100) |
...
| `applyCustomFilter` | `(characteristics, scale, offset)` | Custom filter (5Ã—5 matrix) |
...
// Levels: input 0â€“200, gamma 1.2, output 0â€“255
...
| `opacity` | number | R/W | Group opacity 0â€“100 |
...
| `tracking` | number | R/W | Letter spacing -1000â€“10000 (1000 = 1 em) |
| `horizontalScale` | number | R/W | Horizontal scaling 0â€“1000% |
| `verticalScale` | number | R/W | Vertical scaling 0â€“1000% |
...
| `autoLeadingAmount` | number | R/W | Auto leading percentage 0.01â€“5000 |
...
| Property | Type | R/W | Description |
|----------|------|-----|-------------|
| `leftIndent` | number | R/W | Left indent -1296â€“1296 |
| `rightIndent` | number | R/W | Right indent -1296â€“1296 |
| `firstLineIndent` | number | R/W | First line indent -1296â€“1296 |
| `spaceBefore` | number | R/W | Space before paragraph -1296â€“1296 |
| `spaceAfter` | number | R/W | Space after paragraph -1296â€“1296 |
...
| `warpBend` | number | R/W | Warp bend -100â€“100 |
| `warpHorizontalDistortion` | number | R/W | Horizontal distortion -100â€“100 |
| `warpVerticalDistortion` | number | R/W | Vertical distortion -100â€“100 |
...
| `transform` | string | JSON array â€” the affine transform matrix of the text |
...
## `SolidColor` â€” Color Object

```js
// RGB (most common in Photopea)
var c = new SolidColor();
c.rgb.red   = 255;      // 0â€“255
c.rgb.green = 128;
c.rgb.blue  = 0;
...
c3.gray.gray = 50;    // 0â€“100

// HSB
var c4 = new SolidColor();
c4.hsb.hue        = 30;    // 0â€“360
c4.hsb.saturation = 100;   // 0â€“100
c4.hsb.brightness = 100;   // 0â€“100

// Lab
var c5 = new SolidColor();
c5.lab.l = 50;   // 0â€“100
c5.lab.a = 20;   // -128â€“127
c5.lab.b = 40;   // -128â€“127
...
## `ExportOptionsSaveForWeb` â€” Export to Filesystem
...
## `executeAction` â€” Advanced Operations
