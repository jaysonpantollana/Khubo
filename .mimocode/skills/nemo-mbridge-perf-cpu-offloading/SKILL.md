...
description: "Use when working with nemo-mbridge-perf-cpu-offloading"
---
...
|---|---|
| Large MoE model (30B+), needs PP > 1 | Optimizer offloading â€” activation offloading is blocked by PP=1 |
...
| Throughput is top priority | Don't enable â€” offloading always adds overhead |
| CUDA graphs are needed | Only optimizer offloading â€” activation offloading is incompatible |
| Memory pressure is moderate | Optimizer offload at 25â€“50% fraction for best efficiency |
...
| `optimizer_offload_fraction` | `0.0` | Fraction of optimizer states on CPU (0.0â€“1.0) |
| `overlap_cpu_optimizer_d2h_h2d` | `False` | Overlap GPUâ†”CPU transfers with compute |
