...
description: "Use when working with azure-ai-projects-dotnet"
---
...
```
AIProjectClient
â”œâ”€â”€ Agents          â†’ AIProjectAgentsOperations (versioned agents)
â”œâ”€â”€ Connections     â†’ ConnectionsClient
â”œâ”€â”€ Datasets        â†’ DatasetsClient
â”œâ”€â”€ Deployments     â†’ DeploymentsClient
â”œâ”€â”€ Evaluations     â†’ EvaluationsClient
â”œâ”€â”€ Evaluators      â†’ EvaluatorsClient
â”œâ”€â”€ Indexes         â†’ IndexesClient
â”œâ”€â”€ Telemetry       â†’ AIProjectTelemetry
â”œâ”€â”€ OpenAI          â†’ ProjectOpenAIClient (preview)
â””â”€â”€ GetPersistentAgentsClient() â†’ PersistentAgentsClient
```
...
4. **Clean up resources** â€” delete threads, agents, and files when done
...
8. **Handle pagination** â€” use `AsyncPageable<T>` for listing operations
