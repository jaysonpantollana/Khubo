...
description: "Use when working with tao-run-on-slurm"
---
...
> GPU-idle timeout â€” a long `s3://` download at the top of the script can burn
...
SLURM is the platform of choice for large multi-node runs â€” pass `num_nodes > 1`
...
The SDK install is covered in Preflight â€” `pip install 'nvidia-tao-sdk[slurm]'`.
