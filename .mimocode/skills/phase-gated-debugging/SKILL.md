...
description: "Use when working with phase-gated-debugging"
---
...
### Phase 5: VERIFY
Run original failing test â€” must pass. Run related tests. For intermittent bugs, run 5+ times.
...
| Type | Technique |
|------|-----------|
| Crash/Panic | Stack trace backward â€” trace the bad value to its source |
| Wrong Output | Binary search â€” log midpoint, halve search space each iteration |
| Intermittent | Compare passing vs failing run logs â€” find ordering divergence |
| Regression | `git bisect` â€” find the offending commit |
| Performance | Timing at stage boundaries â€” find the bottleneck |
