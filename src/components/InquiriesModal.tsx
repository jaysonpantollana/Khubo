...
// @behavior: "Reply via CITADEL" button placeholder; "View Property" link to navigate
      ...
      >
        ...
        >
          <div className="flex items-center justify-between p-6 border-b border-neutral-100 shrink-0">
              ...
              <button 
                onClick={onClose}
                className="p-2 bg-neutral-100 rounded-full transition-colors text-neutral-500 text-neutral-900"
              >
                <X size={20} />
              </button>
          </div>
              ...
              <div className="flex flex-col">
                {filteredInquiries.map((inquiry, index) => (
                  <div 
                    ...
                    className={`group flex flex-col md:flex-row md:items-center justify-between gap-4 p-5 bg-neutral-50 cursor-pointer transition-colors ${
